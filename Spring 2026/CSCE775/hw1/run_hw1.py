...
from shared.environments.environment_abstract import State
from shared.environments import env_utils
from shared.visualizer import viz_utils

from argparse import ArgumentParser

from code_hw1 import mrp, dynamic_programming, model_free
...
def main():
    ...
    if args.task == "mrp":
        ...
        gamma_answers: Dict[float, NDArray] = pickle.load(open("data/mrp_example.pkl", "rb"))
