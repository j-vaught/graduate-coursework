...
\node[sublbl, anchor=north west] at (uw_orig.south west) {$f = 14\text{mm}$};
...
\node[sublbl, anchor=north west] at (wd_orig.south west) {$f = 24\text{mm}$};
...
\node[sublbl, anchor=north west] at (tl_orig.south west) {$f = 120\text{mm}$};


% ════════════════════════════════════════════
% Arrows: originals → results (straight through)
% ════════════════════════════════════════════
...
% Fixed arrow target y (all arrows same length)
\def\arrowend{3.8}

% Ultra-wide (enlarged 1.71x relative to 3cm base = 5.13cm)
\node[imgframe, anchor=north] (uw_cstm) at (1.5, \arrowend)
    {\includegraphics[width=5.13cm]{cstm_demo/ultrawide_14mm_cstm.jpg}};
\node[sublbl, anchor=north west] at (uw_cstm.south west)
    {Enlarged $1.71\times$};

% Wide (unchanged, 3cm base)
\node[imgframe, anchor=north] (wd_cstm) at (7.5, \arrowend)
    {\includegraphics[width=3cm]{cstm_demo/wide_24mm_cstm.jpg}};
\node[sublbl, anchor=north west] at (wd_cstm.south west)
    {Unchanged};

% Tele (shrunk 0.2x relative to 3cm base = 0.6cm)
\node[imgframe, anchor=north] (tl_cstm) at (13.5, \arrowend)
    {\includegraphics[width=0.6cm]{cstm_demo/tele_120mm_cstm.jpg}};
\node[sublbl, anchor=north west] at (tl_cstm.south west)
    {Shrunk $0.2\times$};

% Arrows: all same length, from bottom of originals to top of results
\draw[arr=atlantic] (uw_orig.south) -- (1.5, \arrowend);
\draw[arr=horseshoe] (wd_orig.south) -- (7.5, \arrowend);
\draw[arr=rose] (tl_orig.south) -- (13.5, \arrowend);
