...
% \usepackage{balance} % Not available in this TeX installation
...
\author{JC Vaught, Aaron Freer, Trent Miller\\
\small Mechanical Engineering, University of South Carolina, Columbia, SC, USA\\
\small jvaught@sc.edu, freera@email.sc.edu, trentm@email.sc.edu}
...
\noindent\textit{Keywords:} VARTM, VARI, RTM, Resin Infusion, Flow-Front Detection, Machine Vision, Thresholding, CIELAB, Embedded Vision.
