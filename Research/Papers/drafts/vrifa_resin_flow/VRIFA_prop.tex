...
\author{Alex Chayer, JC Vaught, Dr. Professor\\
\small Mechanical Engineering, University of South Carolina, Columbia, SC, USA\\
\small achayer@email.sc.edu, jvaught@sc.edu, prof1@email.sc.edu}
...
\noindent\textit{Keywords:} VARTM, RTM, resin infusion, flow front, computer vision, RGB camera, open source.
