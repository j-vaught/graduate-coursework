...
\small Department of Mechanical Engineering, University of South Carolina, Columbia, SC\\
\small jvaught@sc.edu}

\begin{document}
\maketitle

\noindent\textit{Keywords:} marine radar, gain sweep, dynamic range extension, X-Band, target resolution, HDR
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/incomplete/gain_tradeoff.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/system_diagram.pdf}
\caption{System hardware configuration. A Raspberry Pi controller issues gain and pulse width commands to the Furuno DRS4D-NXT radar transceiver and receives digitized 4-bit echo data. The software loop reads each scan, selects the next gain setting according to the sweep schedule, sends the command, and logs the processed data.}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/incomplete/waterfall.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/incomplete/streaking.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/incomplete/temporal_filtering.pdf}
...
Figure~\ref{fig:gain_curves} shows the expected form of the digitized intensity as a function of receiver gain for three target types. The metal navigation buoy produces a steep gain-response curve, emerging from the noise floor at low gain and saturating at the 4-bit ceiling by mid-range gain settings. Land features exhibit a more gradual response due to their diffuse scattering characteristics. A weaker buoy at greater range requires significantly higher gain before producing detectable returns. At any single fixed gain setting (vertical line), only a subset of this information is available. The full gain sweep recovers the complete response curve, providing effective dynamic range proportional to the number of gain steps.

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/gain_response_curves.pdf}
\caption{Expected reflectivity-versus-gain response curves for three target types. A single fixed gain setting (vertical line) captures only a narrow window of this information. The full gain sweep reconstructs the complete curve, extending effective dynamic range well beyond 4~bits. \textit{Placeholder---replace with real measured curves.}}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/incomplete/dynamic_range_scaling.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/incomplete/merge_threshold.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/incomplete/detection_probability.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/incomplete/pulse_width_comparison.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/incomplete/repeatability.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/incomplete/method_comparison.pdf}
