...
\fill[RadarGreen, opacity=0.15] (\ox+0.85, \oy-0.9) circle (0.14cm);

% Vessel target - bright green, center-right
\fill[RadarGreen, opacity=1.0] (\ox+2.5, \oy-1.8) circle (0.18cm);
...
\fill[RadarGreen, opacity=0.9] (\ox+0.85, \oy-0.9) circle (0.14cm);
...
\foreach \k/\op in {1/0.70, 2/0.50, 3/0.32, 4/0.18, 5/0.08}{
  \fill[RadarGreen, opacity=\op] (\ox+2.5, \oy-1.8+\k*0.11) circle (0.14cm);
}
...
% Buoy - bright
\fill[RadarGreen, opacity=0.95] (\ox+0.85, \oy-0.9) circle (0.14cm);
...
\foreach \k/\op in {1/0.80, 2/0.62, 3/0.46, 4/0.32, 5/0.20, 6/0.12, 7/0.06}{
  \fill[RadarGreen, opacity=\op] (\ox+2.4-\k*0.14, \oy-1.0-\k*0.08) circle (0.14cm);
}
\fill[RadarGreen, opacity=1.0] (\ox+2.4, \oy-1.0) circle (0.18cm);
...
\foreach \k/\op in {1/0.80, 2/0.62, 3/0.46, 4/0.32, 5/0.20, 6/0.12, 7/0.06}{
  \fill[RadarGreen, opacity=\op] (\ox+2.4-\k*0.14, \oy-2.4+\k*0.08) circle (0.14cm);
}
\fill[RadarGreen, opacity=1.0] (\ox+2.4, \oy-2.4) circle (0.18cm);
