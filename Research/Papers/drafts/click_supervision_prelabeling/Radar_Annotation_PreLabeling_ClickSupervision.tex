...
\title{One-Click Annotation for Radar Object Detection}

\author{J.C. Vaught, Yi Wang, Douglas Cahl\\
...
\noindent\textit{Keywords:} Marine radar, PPI, object detection, tracking, annotation, click supervision, pre-labelling, weak supervision.
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{ppi_example_placeholder.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{annotation_styles_placeholder.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{ui_placeholder.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{tracking_placeholder.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{dataset_stats_placeholder.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{detection_performance_placeholder.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{tracking_metrics_placeholder.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{annotation_time_placeholder.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{agreement_placeholder.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{map_comparison_placeholder.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{tracking_curves_placeholder.pdf}
...
If tracking performance remains similar across both training regimes, this provides further evidence that the click-to-annotate pipeline produces labels that are sufficient for downstream multi-object tracking, even though they may not specify exact object boundaries.
