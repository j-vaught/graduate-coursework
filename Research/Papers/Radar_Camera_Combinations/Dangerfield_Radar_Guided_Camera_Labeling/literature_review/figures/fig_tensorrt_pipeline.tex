% This is the unwrapped TikZ-only version (included from ch7 inside its own figure env)
...
\draw[arrow, black90] (pytorch.east) -- ++(1.4,0) node[midway, above, lbl] {Export};
...
\draw[arrow, black90] (onnx.east) -- ++(1.4,0) node[midway, above, lbl] {TRT Compile};
...
\draw[dashed, black90, line width=0.8pt] ($(onnx.south) + (0, -0.5)$) -- ($(opt_title.north) + (0, 0.2)$);
\draw[dashed, black90, line width=0.8pt] ($(tensorrt.south) + (0, -0.5)$) -- ($(opt_title.north) + (0, 0.2)$);
