...
Table~\ref{tab:radar_comparison} summarizes the key differences between X-band marine radar and 77\,GHz automotive radar that affect calibration methodology and achievable accuracy.
