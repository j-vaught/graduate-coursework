...
(Section~\ref{sec:calibration}), progressing through radar-to-camera
projection and bounding box generation (Section~\ref{sec:projection}), and
extending to automated dataset construction methodologies
(Section~\ref{sec:automated_construction}), radar-camera fusion
(Section~\ref{sec:fusion}), X-band signal processing
(Section~\ref{sec:xband}), and edge computing for real-time deployment
