...
\bibitem{hansen1972} V. G. Hansen and H. R. Ward, ``Detection performance of the cell averaging LOG/CFAR receiver,'' \emph{IEEE Trans.\ Aerosp.\ Electron.\ Syst.}, vol.~AES-8, no.~5, pp.~648--652, Sept.\ 1972.
...
\bibitem{farina2005review} A. Farina and F. A. Studer, ``A review of CFAR detection techniques in radar systems,'' \emph{Microwave Journal}, vol.~29, pp.~115--119, Sept.\ 1986.
...
\bibitem{fioranelli2014} L. Rosenberg and S. Bocquet, ``The Pareto distribution for high grazing angle sea-clutter,'' in \emph{Proc.\ IEEE Int.\ Geosci.\ Remote Sens.\ Symp.\ (IGARSS)}, Melbourne, Australia, Jul.\ 2013, pp.~4209--4212.

\bibitem{dong2019} S. Angelliaume, L. Rosenberg, and M. Ritchie, ``Modeling the amplitude distribution of radar sea clutter,'' \emph{Remote Sensing}, vol.~11, no.~3, p.~319, 2019.

\bibitem{humphreys2022} E. Humphreys, M. Antoniou, C. J. Baker, and P. Clark, ``Cognitive CFAR parameter optimization for detection in sea clutter,'' in \emph{Proc.\ Int.\ Conf.\ Radar Syst.\ (RADAR 2022)}, Edinburgh, UK, Oct.\ 2022, pp.~148--153.

\bibitem{vicfar2014} S. M. H. Sharifi and M. Modarres-Hashemi, ``Variability-index CFAR for heterogeneous environments,'' \emph{Digital Signal Process.}, vol.~34, pp.~32--41, 2014. % NOTE: Could not be independently verified -- check against original source

\bibitem{nncfar2019} B. P. A. Rohman and D. Kurniawan, ``Neural network-based adaptive selection CFAR for radar target detection in various environments,'' \emph{Int.\ J.\ Intell.\ Syst.\ Technol.\ Appl.}, vol.~18, no.~4, pp.~377--390, 2019.

\bibitem{cfarnet2024} T. Diskin, Y. Beer, U. Okun, and A. Wiesel, ``CFARnet: Deep learning for target detection with constant false alarm rate,'' \emph{Signal Process.}, vol.~223, p.~109543, 2024.

\bibitem{seefurther2024} I. Roldan, A. Palffy, J. F. P. Kooij, D. M. Gavrila, F. Fioranelli, and A. Yarovoy, ``See further than CFAR: A data-driven radar detector trained by lidar,'' in \emph{Proc.\ IEEE Radar Conf.\ (RadarConf24)}, Denver, CO, USA, May 2024, pp.~1--6.

\bibitem{salalstm2023} J. Wang and S. Li, ``SALA-LSTM: A novel high-precision maritime radar target detection method based on deep learning,'' \emph{Scientific Reports}, vol.~13, art.~12125, 2023.

\bibitem{farina2008kb} A. De Maio, A. Farina, and G. Foglia, ``Design and experimental validation of knowledge-based constant false alarm rate detectors,'' \emph{IET Radar, Sonar Navig.}, vol.~1, no.~4, pp.~308--316, Aug.\ 2007.

\bibitem{wicks1996} M. C. Wicks, W. J. Baldygo, Jr., and R. D. Brown, ``Expert system constant false alarm rate (CFAR) processor,'' U.S.\ Patent 5,499,030, Mar.\ 1996.

\bibitem{dhs2009} U.S.\ Dept.\ of Homeland Security, ``Small boat intrusion detection systems with radar,'' System Assessment and Validation for Emergency Responders (SAVER) TechNote, Sept.\ 2009.
\end{thebibliography}
