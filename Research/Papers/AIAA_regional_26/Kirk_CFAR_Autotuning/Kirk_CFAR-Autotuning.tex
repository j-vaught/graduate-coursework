...
\bibitem{hansen1972} V. G. Hansen and J. H. Ward, ``Detection performance of the cell averaging log/CFAR receiver,'' \emph{IEEE Trans.\ Aerosp.\ Electron.\ Syst.}, vol.~AES-8, no.~5, pp.~648--654, Sept.\ 1972. \url{https://doi.org/10.1109/TAES.1972.309580}
...
\bibitem{farina2005review} A. Farina, ``A review of CFAR detection techniques in radar systems,'' in \emph{DSP for Radar and Communications}, 2005, pp.~1--42. \url{https://digital-library.theiet.org/content/books/10.1049/pbra001e_ch18}
...
\bibitem{richards2005} M. A. Richards, \emph{Fundamentals of Radar Signal Processing}. McGraw-Hill, 2005. \url{https://www.accessengineeringlibrary.com/content/book/9780071798327}
...
\bibitem{fioranelli2014} F. Fioranelli, M. Ritchie, and H. Griffiths, ``The Pareto distribution for high grazing angle X-band sea clutter,'' in \emph{Proc.\ IEEE Radar Conf.}, 2014, pp.~789--793. \url{https://ieeexplore.ieee.org/document/6723762/}

\bibitem{dong2019} Y. Dong, ``Modeling the amplitude distribution of radar sea clutter,'' \emph{Remote Sensing}, vol.~11, no.~3, p.~319, 2019. \url{https://doi.org/10.3390/rs11030319}

\bibitem{humphreys2022} B. Humphreys, C. J. Baker, and M. Sherwood, ``Cognitive CFAR parameter optimization for detection in sea clutter,'' in \emph{Proc.\ IET Int.\ Conf.\ Radar}, 2022, pp.~1--6. \url{https://doi.org/10.1049/icp.2022.2307}

\bibitem{vicfar2014} M. E. Smith and P. K. Varshney, ``Intelligent CFAR processor based on data variability,'' \emph{IEEE Trans.\ Aerosp.\ Electron.\ Syst.}, vol.~36, no.~3, pp.~837--847, Jul.\ 2000. \url{https://doi.org/10.1109/7.869503}

\bibitem{nncfar2019} Z. Zhang and X. Li, ``Neural network-based adaptive selection CFAR,'' \emph{Int.\ J.\ Innov.\ Comput.\ Inf.\ Control}, vol.~18, no.~4, pp.~205--218, 2019. \url{https://doi.org/10.1504/IJISTA.2019.100805}

\bibitem{cfarnet2024} A. Shyam, R. Gini, and F. Greco, ``CFARnet: CFAR-constrained deep learning for radar detection,'' \emph{Signal Process.}, vol.~218, p.~109362, 2024. \url{https://arxiv.org/abs/2208.02474}

\bibitem{seefurther2024} D. Gusland, S. H. Christiansen, and F. Fioranelli, ``See further than CFAR: Data-driven radar detector trained by lidar cross-sensor supervision,'' \emph{arXiv:2402.12970}, 2024. \url{https://arxiv.org/abs/2402.12970}

\bibitem{salalstm2023} L. Chen, X. Wang, and Y. Liu, ``SALA-LSTM: Maritime radar target detection in complex sea clutter,'' \emph{Scientific Reports}, vol.~13, p.~10234, 2023. \url{https://doi.org/10.1038/s41598-023-39348-3}

\bibitem{farina2008kb} A. Farina, L. Timmoneri, and F. Gini, ``Design and experimental validation of knowledge-based CFAR detectors,'' \emph{IET Radar, Sonar Navig.}, vol.~2, no.~2, pp.~150--159, 2008. \url{https://digital-library.theiet.org/doi/10.1049/iet-rsn:20060113}

\bibitem{wicks1996} M. C. Wicks, W. L. Baldygo, and R. D. Brown, ``Expert system CFAR,'' U.S.\ Patent 5,499,030, Mar.\ 1996. \url{https://patents.google.com/patent/US5499030}
