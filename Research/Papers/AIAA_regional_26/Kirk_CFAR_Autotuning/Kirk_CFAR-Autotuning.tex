...
\bibitem{finn1968} H. M. Finn and R. S. Johnson, ``Adaptive detection mode with threshold control as a function of spatially sampled clutter level estimates,'' \emph{RCA Review}, vol.~29, pp.~414--463, Sept.\ 1968.
...
\bibitem{vicfar2014} M. E. Smith and P. K. Varshney, ``Intelligent CFAR processor based on data variability,'' \emph{IEEE Trans.\ Aerosp.\ Electron.\ Syst.}, vol.~36, no.~3, pp.~837--847, Jul.\ 2000.
...
\bibitem{dhs2009} U.S.\ Dept.\ of Homeland Security, ``Small boat intrusion detection systems with radar,'' System Assessment and Validation for Emergency Responders (SAVER) TechNote, 2009.
\end{thebibliography}
