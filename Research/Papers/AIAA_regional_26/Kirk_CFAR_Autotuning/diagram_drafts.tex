...
\begin{scope}[shift={(#1,0)}]
  ...
  \draw[{Stealth[length=2.5pt]}-{Stealth[length=2.5pt]},gray70]
    (-0.2,1*\gsz) -- (-0.2,4*\gsz);
  \node[left,font=\tiny] at (-0.2,2.5*\gsz) {$N_r$};
  \draw[{Stealth[length=2.5pt]}-{Stealth[length=2.5pt]},gray70]
    (-0.2,4*\gsz) -- (-0.2,5*\gsz);
  \node[left,font=\tiny] at (-0.2,4.5*\gsz) {$G$};

  % Selection arrow for GO/SO
  \ifnum#3=1
    \draw[-{Stealth[length=4pt]},black,very thick]
      (11*\gsz+0.3,7.5*\gsz) -- (11*\gsz+0.3,9*\gsz);
    \node[right,font=\tiny] at (11*\gsz+0.35,8.2*\gsz) {max};
  \fi
  \ifnum#3=2
    \draw[-{Stealth[length=4pt]},black,very thick]
      (11*\gsz+0.3,3.5*\gsz) -- (11*\gsz+0.3,1.5*\gsz);
    \node[right,font=\tiny] at (11*\gsz+0.35,2.5*\gsz) {min};
  \fi
