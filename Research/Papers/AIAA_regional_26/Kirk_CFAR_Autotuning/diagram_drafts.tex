...
% --- Intensity values for each cell (11x11, row-major, center=target) ---
% Synthetic power values: target at center, gradient falloff + noise
\def\cellpwr{{1,1,2,1,2,1,2,1,2,1,1,
               1,2,1,2,2,3,2,2,1,2,1,
               2,1,2,3,3,4,3,3,2,1,2,
               1,2,3,3,5,6,5,3,3,2,1,
               2,2,3,5,8,9,8,5,3,2,2,
               1,3,4,6,9,18,9,6,4,3,1,
               2,2,3,5,8,9,8,5,3,2,2,
               1,2,3,3,5,6,5,3,3,2,1,
               2,1,2,3,3,4,3,3,2,1,2,
               1,2,1,2,2,3,2,2,1,2,1,
...
% === Raw intensity grid (CUT highlighted, all others show power as color) ===
\newcommand{\rawGrid}[2]{% #1=x-offset, #2=title
\begin{scope}[shift={(#1,0)}]
  \node[font=\bfseries] at (5*\gsz+\gsz/2,\gn*\gsz+\gsz+0.4) {#2};
  \foreach \r in {0,...,\gn}{
    \foreach \c in {0,...,\gn}{
      \pgfmathtruncatemacro{\idx}{\r*11+\c}
      \pgfmathtruncatemacro{\val}{\cellpwr[\idx]}
...
\begin{scope}[shift={(0,7.5)}]
  \rawGrid{1}{Raw Power}
  \rawGrid{7.5}{Raw Power}
  \rawGrid{14}{Raw Power}
\end{scope}
