...
%% ============================================================
%% OFFICIAL AIAA CONFERENCE TEMPLATE REFERENCE
%% ============================================================
%% The following is the official AIAA conference paper template
%% structure from Overleaf / AIAA Technical Presenter Resources.
%% Your paper above already conforms to this format.
%%
%% Document class: \documentclass[conf]{new-aiaa}
%%   - [conf] = conference format (single-spaced)
%%   - [journal] = journal format (double-spaced)
%%
%% Required formatting (handled by new-aiaa.cls):
%%   - Font: Times New Roman, 10pt (newtxtext/newtxmath)
%%   - Margins: 1 inch on all sides (letterpaper)
%%   - Sections: bold, 11pt (large), centered, Roman numerals
%%   - Subsections: bold, flush left, lettered (A, B, C...)
%%   - Sub-subsections: italic, flush left, numbered
%%   - Abstract: bold, indented 0.5in left and right
%%   - Figures: labeled "Fig." with bold captions below
%%   - Tables: bold captions above
%%   - References: numbered in brackets [1], small font
%%
%% Official template preamble packages:
%%   \usepackage[utf8]{inputenc}    % (loaded by cls)
%%   \usepackage{graphicx}
%%   \usepackage{amsmath}
%%   \usepackage{mhchem}            % optional, for chemistry
%%   \usepackage{siunitx}           % optional, for SI units
%%   \usepackage{longtable,tabularx}% optional, for tables
%%
%% Author block format:
%%   \author{First M. Last\footnote{Job Title, Department, AIAA Member Grade.}}
%%   \affil{University Name, City, State, Zip Code}
%%
%% Bibliography options:
%%   Option A: \bibliography{sample.bib}  with natbib (preferred)
%%   Option B: \begin{thebibliography}{99} ... \end{thebibliography}
%%
%% KEY DIFFERENCE: Conference vs Journal
%%   - Conference [conf]: single-spaced, no page numbers on first page
%%   - Journal [journal]: double-spaced throughout
%%   Both use the SAME new-aiaa.cls and the SAME formatting rules.
%%   There is NO separate "regional conference" template.
%%
%% Source: https://www.overleaf.com/latex/templates/preparation-of-papers-for-aiaa-technical-conferences/rsssbwthkptn
%% GitHub: https://github.com/zbeekman/AIAA-Conf-Template
%% ============================================================
