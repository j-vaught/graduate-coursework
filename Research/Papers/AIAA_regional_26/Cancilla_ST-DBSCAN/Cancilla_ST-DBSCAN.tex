...
We insert all Cartesian points into a spatial hash with cell size $h = 2\varepsilon_{s,\max}$. This ensures potential neighbors lie within a $3 \times 3$ cell grid, limiting search complexity.
