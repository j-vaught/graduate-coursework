...
\label{tab:schema}
\begin{tabular*}{\textwidth}{@{}l@{\extracolsep{\fill}}l@{\hspace{1.5em}}ll@{}}
\toprule
Field & Description & Field & Description \\
\midrule
timestamp\_w & Wide-frame timestamp & timestamp\_p & PTZ-frame timestamp \\
image\_w & Wide image or clip key & telemetry\_p & PTZ pan/tilt/zoom/exposure \\
bbox\_w & Label box (wide coords) & bbox\_p, score\_p & PTZ box and confidence \\
class & Target class & quality\_metrics & Blur, saturation, occlusion \\
score\_w & Wide detector confidence & site\_meta & Location, orientation, weather \\
\bottomrule
\end{tabular*}
\end{table}
...
\midrule
Compute platform & \multicolumn{2}{l}{NVIDIA Jetson Orin AGX} \\
Software stack & \multicolumn{2}{l}{JetPack 4.7, CUDA 12.6} \\
Cameras & \multicolumn{2}{l}{2$\times$ FLIR M300C} \\
Power & \multicolumn{2}{l}{12.8\,V 50\,Ah LiFePO4} \\
Network & \multicolumn{2}{l}{PCIe Ethernet, IEEE 802.3at PoE} \\
Camera latency & \multicolumn{2}{l}{0.2--0.6\,ms (network)} \\
Wide FOV & \multicolumn{2}{l}{$60^\circ$H $\times$ $45^\circ$V} \\
Video codec & \multicolumn{2}{l}{MJPEG (frame-independent)} \\
\midrule
\multicolumn{3}{@{}l}{\textit{Detector Throughput}} \\
\midrule
...
\label{tab:tracking}
\begin{tabular*}{\textwidth}{@{}l@{\extracolsep{\fill}}cc@{\hspace{1.5em}}lcc@{}}
\toprule
