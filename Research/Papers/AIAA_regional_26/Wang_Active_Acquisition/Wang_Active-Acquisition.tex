...
\caption{Field of view comparison. The wide camera (light gray) covers approximately $60^\circ$ horizontally for persistent surveillance, while the PTZ camera (dark) provides a narrow, steerable view.}
\label{fig:fov}
\end{figure}
