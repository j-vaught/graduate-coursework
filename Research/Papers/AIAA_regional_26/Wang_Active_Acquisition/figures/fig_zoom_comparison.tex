...
\begin{tikzpicture}
  ...
  \begin{scope}[shift={(0,0)}]
    ...
    % Removed thick gray background
    \draw[line width=1.5pt, black, fill=white] (-2,-1.5) rectangle (2,1.5);
    
    % Crosshairs (subtle)
    \draw[black!40, thin] (-2,0) -- (2,0);
    \draw[black!40, thin] (0,-1.5) -- (0,1.5);
     \draw[line width=1.5pt, black] (-2,-1.5) rectangle (2,1.5);
    
    % Scattered scene elements (other objects - birds, clouds, etc)
    \foreach \x/\y in {-1.5/1.0, -1.2/-0.8, 1.6/0.6, 1.3/-1.1, -0.3/1.2, 1.7/-0.2} {
      \fill[black!30] (\x, \y) circle (2pt);
    }
    ...
    \node[font=\scriptsize, black, anchor=south west] at (-0.15, 0.48) {5x region};
    
    % Labels
    \node[font=\small\bfseries, black] at (0, 1.95) {\textbf{Wide FOV (1x)}};
    \node[font=\scriptsize, black] at (0, -1.95) {Target: $\sim$15 px};
  \end{scope}
  
  % Arrow 1->2
  \draw[-{Stealth[length=3.5mm, width=2.5mm]}, very thick, black] (2.6, 0) -- (3.4, 0);
  \node[font=\scriptsize, black, align=center] at (3.0, 0.4) {zoom};
  ...
  \begin{scope}[shift={(6.0,0)}]
    ...
    \node[font=\scriptsize, black, anchor=south west] at (-0.1, 0.7) {20x region};
    
    % Labels
    \node[font=\small\bfseries, black] at (0, 1.95) {\textbf{5x Zoom}};
    \node[font=\scriptsize, black] at (0, -1.95) {Target: $\sim$60 px};
  \end{scope}
  
  % Arrow 2->3
  \draw[-{Stealth[length=3.5mm, width=2.5mm]}, very thick, black] (8.6, 0) -- (9.4, 0);
  \node[font=\scriptsize, black, align=center] at (9.0, 0.4) {zoom};
  ...
  \begin{scope}[shift={(12.0,0)}]
    ...
    % Labels
    \node[font=\small\bfseries, black] at (0, 1.95) {\textbf{20x Zoom}};
    \node[font=\scriptsize, black] at (0, -1.95) {Target: $\sim$300 px};
  \end{scope}
