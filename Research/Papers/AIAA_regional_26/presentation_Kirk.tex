...
\graphicspath{{Kirk_CFAR_Autotuning/}}
...
\begin{center}
\includegraphics[width=0.8\textwidth,height=0.7\textheight,keepaspectratio]{figures/ppi_full_view_detections_and_ground_truth.png}
\end{center}
\scriptsize
...
\begin{center}
\includegraphics[width=0.9\textwidth,height=0.7\textheight,keepaspectratio]{figures/full_ui_ppi_with_optimization_results.png}
\end{center}
\scriptsize
...
\begin{center}
\includegraphics[width=0.7\textwidth,height=0.7\textheight,keepaspectratio]{figures/bscan_view_grayscale_with_cfar_detections.png}
\end{center}
\scriptsize
