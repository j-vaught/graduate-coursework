...
\foreach \i/\op in {1/0.06,2/0.10,3/0.15,4/0.20,5/0.26,6/0.33,7/0.41,8/0.50,9/0.60,10/0.72,11/0.85,12/1.0}{%
  \fill[Grass, opacity=\op] ({0.40 - \i*0.8*0.10}, {0.30 - \i*0.6*0.10}) circle (2.5pt);
}
\fill[Grass] (0.40, 0.30) circle (4pt);

% --- MID target (fixed N=12): moderate spacing
% Target at ~(1.04, 0.78), direction (0.8, 0.6), spacing 0.085cm
\foreach \i/\op in {1/0.06,2/0.10,3/0.15,4/0.20,5/0.26,6/0.33,7/0.41,8/0.50,9/0.60,10/0.72,11/0.85,12/1.0}{%
  \fill[Grass, opacity=\op] ({1.04 - \i*0.8*0.085}, {0.78 - \i*0.6*0.085}) circle (2.5pt);
}
\fill[Grass] (1.04, 0.78) circle (4pt);

% --- FAR target (fixed N=12): short effective displacement (0.030cm spacing)
% Target at ~(1.56, 1.17), direction (0.8, 0.6), spacing 0.030cm
\foreach \i/\op in {1/0.06,2/0.10,3/0.15,4/0.20,5/0.26,6/0.33,7/0.41,8/0.50,9/0.60,10/0.72,11/0.85,12/1.0}{%
  \fill[Grass, opacity=\op] ({1.56 - \i*0.8*0.030}, {1.17 - \i*0.6*0.030}) circle (2.5pt);
}
\fill[Grass] (1.56, 1.17) circle (4pt);
...
\foreach \i/\op in {1/0.30,2/0.65,3/1.0}{%
  \fill[Grass, opacity=\op] ({\cx+0.40 - \i*0.8*0.08}, {0.30 - \i*0.6*0.08}) circle (2.5pt);
}
\fill[Grass] ({\cx+0.40}, 0.30) circle (4pt);
...
\foreach \i/\op in {1/0.07,2/0.14,3/0.22,4/0.31,5/0.41,6/0.52,7/0.63,8/0.74,9/0.87,10/1.0}{%
  \fill[Grass, opacity=\op] ({\cx+1.04 - \i*0.8*0.075}, {0.78 - \i*0.6*0.075}) circle (2.5pt);
}
\fill[Grass] ({\cx+1.04}, 0.78) circle (4pt);
...
\foreach \i/\op in {1/0.04,2/0.07,3/0.10,4/0.14,5/0.18,6/0.23,7/0.28,8/0.33,9/0.39,10/0.45,11/0.51,12/0.57,13/0.63,14/0.69,15/0.75,16/0.80,17/0.86,18/0.91,19/0.96,20/1.0}{%
  \fill[Grass, opacity=\op] ({\cx+1.56 - \i*0.8*0.028}, {1.17 - \i*0.6*0.028}) circle (2.5pt);
}
\fill[Grass] ({\cx+1.56}, 1.17) circle (4pt);
