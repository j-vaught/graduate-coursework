...
Usage:
    ...
    python visualize_paths.py scenes/*.yaml -o outputs/path_previews/
"""
...
from radar_utils import (
    AnnotationSet, ConversionConfig, RadarConverter, NUM_RANGE_BINS,
    BinaryMask, PolarMask, create_water_mask, generate_path,
    load_scene, compute_valid_positions, find_water_edge_positions,
)
