...
Required for first-time applicants (approximately 1-hour video series). If you watched it in a previous semester, you do not need to repeat it.

\subsection{Step 4: Develop Your Proposal}

Write a competitive research, scholarly, or creative project proposal in collaboration with your faculty mentor. The project description is limited to \textbf{2 pages}. The key to a successful application is \textbf{how well you describe your project plan}---make sure you understand your project in sufficient detail to explain it in language a non-expert will understand.
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Work performed before the grant start date}
\end{itemize}

\warnbox{Student salary is paid \textbf{hourly with timecards}. All travel requires \textbf{pre-approval} from the mentor and must comply with USC travel policies.}
...
\subsection{Presentation Requirement}

All awardees must present their research at one USC-sponsored event:
\begin{itemize}[nosep]
    \item \textbf{Discover USC} (April) --- preferred venue
    \item \textbf{Summer Research Symposium} (end of July)
    \item \textbf{Fall Showcase} (through CIEL, early November)
\end{itemize}

\subsection{Final Research Report}

Submit a \textbf{1--2 page research report} within 1 month of project completion.

\subsection{No Extensions}

Extensions past the stated end date or after the student graduates are \textbf{not permitted}. All work, including travel, must be completed before graduation.
...
\subsection{Computer Science \& Engineering (Spring 2022)}

\begin{longtable}{@{}p{3.5cm} p{10.5cm}@{}}
\toprule
\textbf{Student} & \textbf{Project Title} \\
\midrule
\endhead
Ian McDowell \& Rahul Bulusu & Drone-based Multimodal Surveying for Outdoor 5G Millimeter-Wave Picocell Placement \\
Cassidy Carter & Detection and Discovery of Structural Motifs in Crystal Materials Using Quotient Graphs \\
James Seekings & Attention Tracking for Intuitive Robot Tutors Using Neuromorphic Computing \\
Edward Sitar & 5G Millimeter-Wave Enabled At-Home Human Silhouette Estimation \\
Corinne Smith & A Network of UAV Deployable Sensor Packages for Monitoring Hydraulic Parameters During Severe Weather Events \\
Lexington Whalen & The Wordification Project \\
\bottomrule
\end{longtable}

\subsection{Computer Science \& Engineering (Spring 2020)}
...
\midrule
\endhead
Ensemble of Many Weak Defenses: Defending Deep Neural Networks Against Adversarial Attacks \\
Multi-stage Compression of Deep Neural Networks through Pruning and Knowledge Distillation \\
Deep Residual Learning for Computational Identification of Amino Acids \\
A Study on Dissemination of Fake News in 2016 and 2020 Presidential Elections \\
Genetic Programming Based Symbolic Regression for Material Thermal Conductivity Prediction \\
Expanding upon REDCRAFT and REDCAT for Analyzing and Characterizing Proteins from Residual Dipolar Couplings \\
\bottomrule
\end{longtable}

\subsection{Sport \& Entertainment Management (2019)}

\begin{longtable}{@{}p{3.5cm} p{7cm} p{3.5cm}@{}}
\toprule
\textbf{Student} & \textbf{Project} & \textbf{Location} \\
\midrule
\endhead
Morgan Bueter & Sponsorship Conflict in Professional Sports (Ronaldo vs.\ Juventus sponsorships) & Torino, Italy \\
David Brake & Sustainable Practices at Sporting Venues (comparative environmental study) & Australia \\
Anthony Carson & Research on the Rio Olympics & Rio de Janeiro \\
\bottomrule
\end{longtable}
...
\begin{quote}
\textit{``I have always been interested in conducting research during my time at South Carolina, but I wasn't sure what it would look like for me. I was also interested in studying abroad and realized the Magellan grant could potentially give me the opportunity to pursue both interests at the same time.''}\\
\hfill --- \textbf{Morgan Bueter}, Sport \& Entertainment Management
\end{quote}

\begin{quote}
\textit{``Absolutely go for it and rely on the support of your professors---they want to help you succeed. My semester abroad pursuing research was the best four and a half months of my life.''}\\
\hfill --- \textbf{Morgan Bueter}
\end{quote}

\begin{quote}
\textit{``It was certainly a culture shock for me, but the experience was incredible and being able to tie it in to things through the university certainly made the experience worthwhile.''}\\
\hfill --- \textbf{Anthony Carson}, Sport \& Entertainment Management
\end{quote}

\begin{quote}
\textit{``Research at USC has totally influenced the trajectory of my life\ldots it can have a positive impact on a student's experience.''}\\
\hfill --- \textbf{Undergraduate Research Ambassador}
\end{quote}

\begin{quote}
\textit{``Our faculty really believe in undergraduate research as an incredible learning experience for students.''}\\
\hfill --- \textbf{Julie Morris}, Founding Director, Office of Undergraduate Research (2004--2022)
\end{quote}
