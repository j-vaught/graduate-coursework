# Opinion Editor Onboarding Guide
...
|---------|---------|-------|
| **CEO3 by SNworks** | Article writing, previewing, adding titles/authors, and managing publication workflow | Get credentials from outgoing editor or Editor-in-Chief |
| **Slack (Daily Gamecock workspace)** | All editorial communication, budgeting, and handoffs | Recommended: sign up with your USC `@mailbox.sc.edu` email rather than `@email.sc.edu` for fewer login issues |

No other tools are strictly required. Most editors use **Google Docs** for drafting and collaboration. LaTeX and Python scripts in this repo are personal tools of the previous editor and are not part of the standard workflow.
...
|----------|-------|---------|
| **A** | **Factuality** | Verify all sources. Do not accept Wikipedia as a source. If a source is not available online, leave a comment in CEO for the Copy desk to verify behind you. |
...
- Talk to the **Editor-in-Chief** to approve an accelerated timeline.
...
1. In the Budget sheet, add the text **PUSHED** (bold) before the article title.
2. Change the cell color to **red**.
3. Move the entry to the **bottom** of the Budget sheet.

When rescheduling:

- Add the article to its **new date** in the Budget.
- Do **not** write "PUSHED" next to the rescheduled entry.
