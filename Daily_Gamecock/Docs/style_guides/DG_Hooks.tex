...
\begin{seasonbox}[Revised Hook --- with three closing options]
Disney has released 18 live-action remakes of animated classics since 2010. Combined, they've grossed over \$10 billion. Yet all in total, they have contributed zero original ideas.

\textbf{Option A:} The \textit{Lion King} remake isn't the worst offender --- it's the most revealing. Disney doesn't need to make this film. It needs you to pay for the memory of a film they already made.

\textbf{Option B:} The \textit{Lion King} remake is next, and it might be the most honest one yet: a shot-for-shot copy that doesn't even pretend to have a reason to exist beyond the box office.

\textbf{Option C:} \textit{The Lion King} is next --- and unlike \textit{Cinderella} or \textit{The Jungle Book}, Disney isn't even bothering to reimagine it. The remake is a photocopy with a \$250 million budget and nothing new to say.
\end{seasonbox}
