...
%--- Example 7 ---
\subsection*{``Affordable Care Act helps some at the price of many'' --- Ross Abbott, 12/4/13}
...
%--- Example 8 ---
\subsection*{``Column: Failure to indict Wilson result of broken system'' --- Ross Abbott, 12/4/14}
...
%--- Example 9 ---
\subsection*{``Column: Flag burning is protected speech'' --- Dan Nelson, 11/30/16}
...
%--- Example 10 ---
\subsection*{``Column: It's time for USC's community to fight for its campus workers'' --- Shannon Kavaja, 11/30/23}
...
%--- Example 11 ---
\subsection*{``Column: Assembly Street is a danger to pedestrians'' --- JC Vaught, 4/24/25}
