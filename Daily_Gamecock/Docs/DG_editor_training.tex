...
% Section formatting
\titleformat{\section}[block]{\LARGE\bfseries\color{dgred}}{}{0pt}{}
...
\title{\Huge\textbf{The Daily Gamecock \textit{Opinion} Editing Handbook}\\\vspace{0.5em}\Large A somewhat useful guide for editors}
\author{}
\date{}
\maketitle
...
\begin{center}
\large\textit{Welcome to the Daily Gamecock \textbf{Opinion} editorial team}.

J.C. Vaught, Asst. Opinion Editor
...
\begin{Form}
\noindent\CheckBox[name=statement-verification,width=1em,height=1em]{} \hyperref[sec:statement-verification]{\textcolor{blue}{Verify all definitive statements have proper sourcing}}

\vspace{0.3em}
\noindent\CheckBox[name=date-verification,width=1em,height=1em]{} \hyperref[sec:date-verification]{\textcolor{blue}{Check every date against two independent sources}}

\vspace{0.3em}
\noindent\CheckBox[name=name-verification,width=1em,height=1em]{} \hyperref[sec:name-verification]{\textcolor{blue}{Confirm spelling and titles of all quoted individuals}}

\vspace{0.3em}
\noindent\CheckBox[name=quote-verification,width=1em,height=1em]{} \hyperref[sec:quote-verification]{\textcolor{blue}{Ensure all quotes match recorded interviews exactly}}

\vspace{0.3em}
\noindent\CheckBox[name=fact-checking,width=1em,height=1em]{} \hyperref[sec:fact-checking]{\textcolor{blue}{Cross-reference statistics and data with original sources}}
\end{Form}

\subsection{Structural Analysis}

\begin{Form}
\noindent\CheckBox[name=lede-assessment,width=1em,height=1em]{} \hyperref[sec:lede-assessment]{\textcolor{blue}{Confirm the lede states a clear, arguable position}}

\vspace{0.3em}
\noindent\CheckBox[name=nutgraf-check,width=1em,height=1em]{} \hyperref[sec:nutgraf-check]{\textcolor{blue}{Verify the nutgraf provides essential context within 75 words}}

\vspace{0.3em}
\noindent\CheckBox[name=subhead-placement-check,width=1em,height=1em]{} \hyperref[sec:subhead-placement]{\textcolor{blue}{Ensure first subhead after lede is factual, not tonal}}

\vspace{0.3em}
\noindent\CheckBox[name=nutgraf-placement-check,width=1em,height=1em]{} \hyperref[sec:nutgraf-placement]{\textcolor{blue}{Position nutgraf within first three paragraphs}}

\vspace{0.3em}
\noindent\CheckBox[name=transition-flow-check,width=1em,height=1em]{} \hyperref[sec:transition-flow]{\textcolor{blue}{Check transitions connect ideas smoothly between paragraphs}}
\end{Form}

\subsection{Source and Attribution Standards}

\begin{Form}
\noindent\CheckBox[name=attribution-format,width=1em,height=1em]{} \hyperref[sec:attribution-format]{\textcolor{blue}{Format first references with full name, title, and credentials}}

\vspace{0.3em}
\noindent\CheckBox[name=subsequent-references,width=1em,height=1em]{} \hyperref[sec:subsequent-references]{\textcolor{blue}{Use last name only for subsequent references}}

\vspace{0.3em}
\noindent\CheckBox[name=interview-verification,width=1em,height=1em]{} \hyperref[sec:interview-verification]{\textcolor{blue}{Confirm interview recordings sent to copy desk}}

\vspace{0.3em}
\noindent\CheckBox[name=statement-requests,width=1em,height=1em]{} \hyperref[sec:statement-requests]{\textcolor{blue}{Verify statements requested from all criticized parties}}

\vspace{0.3em}
\noindent\CheckBox[name=source-quality,width=1em,height=1em]{} \hyperref[sec:source-quality]{\textcolor{blue}{Replace blog sources with established media when possible}}
\end{Form}

\subsection{Style and Formatting}

\begin{Form}
\noindent\CheckBox[name=ap-dates,width=1em,height=1em]{} \hyperref[sec:ap-dates]{\textcolor{blue}{Apply AP style to all dates and numbers}}

\vspace{0.3em}
\noindent\CheckBox[name=title-capitalization,width=1em,height=1em]{} \hyperref[sec:title-capitalization]{\textcolor{blue}{Capitalize formal titles before names, lowercase after}}

\vspace{0.3em}
\noindent\CheckBox[name=quote-punctuation,width=1em,height=1em]{} \hyperref[sec:quote-punctuation]{\textcolor{blue}{Place periods inside quotation marks}}

\vspace{0.3em}
\noindent\CheckBox[name=attribution-verbs,width=1em,height=1em]{} \hyperref[sec:attribution-verbs]{\textcolor{blue}{Use ``said'' for attribution, avoid ``stated'' or ``mentioned''}}

\vspace{0.3em}
\noindent\CheckBox[name=paragraph-length,width=1em,height=1em]{} \hyperref[sec:paragraph-length]{\textcolor{blue}{Keep paragraphs to 1-4 sentences maximum}}
\end{Form}

\subsection{Final Quality Control}

\begin{Form}
\noindent\CheckBox[name=headline-accuracy,width=1em,height=1em]{} \hyperref[sec:headline-accuracy]{\textcolor{blue}{Ensure headline accurately reflects article's main argument}}

\vspace{0.3em}
\noindent\CheckBox[name=word-count,width=1em,height=1em]{} \hyperref[sec:word-count]{\textcolor{blue}{Confirm word count meets publication requirements}}

\vspace{0.3em}
\noindent\CheckBox[name=hyperlink-check,width=1em,height=1em]{} \hyperref[sec:hyperlink-check]{\textcolor{blue}{Test all hyperlinks for functionality}}

\vspace{0.3em}
\noindent\CheckBox[name=readability,width=1em,height=1em]{} \hyperref[sec:readability]{\textcolor{blue}{Read aloud to catch awkward phrasing}}

\vspace{0.3em}
\noindent\CheckBox[name=consistency,width=1em,height=1em]{} \hyperref[sec:consistency]{\textcolor{blue}{Maintain consistent voice and tone throughout}}
\end{Form}
...
\begin{tikzpicture}[node distance=2cm]
    \node (start) [draw, rounded corners, minimum width=3cm, minimum height=1cm] {Incoming Article};
    \node (assess) [draw, diamond, aspect=2, below of=start, minimum width=3cm, minimum height=2cm] {Quality Assessment};
    \node (level1) [draw, rounded corners, below left of=assess, minimum width=2.5cm, minimum height=1cm, xshift=-2cm, yshift=-1cm] {Level 1: Full Rewrite};
    \node (level2) [draw, rounded corners, below of=assess, minimum width=2.5cm, minimum height=1cm, yshift=-4cm] {Level 2: Sectional Rewrite};
    \node (level3) [draw, rounded corners, below right of=assess, minimum width=2.5cm, minimum height=1cm, xshift=2cm, yshift=-1cm] {Level 3: Comment Pass};
...
\begin{tikzpicture}[node distance=5cm]
    \node (original) [draw, rounded corners, minimum width=4cm, minimum height=0.8cm] {Original Draft};
    \node (research) [draw, rounded corners, right of=original, minimum width=4cm, minimum height=0.8cm] {Research Review};
    \node (reporting) [draw, rounded corners, right of=research, minimum width=4cm, minimum height=0.8cm] {Additional Reporting};
    \node (structure) [draw, rounded corners, below of=reporting, minimum width=4cm, minimum height=0.8cm] {Restructure};
...
\begin{afterbox}
\textbf{\textcolor{blue}{Revised section -JC (tightened for clarity, added specific data):}}
...
\begin{afterbox}
\textbf{\textcolor{blue}{Revised section -JC (added context, removed repetition):}}
...
\begin{afterbox}
\textbf{\textcolor{blue}{Revised section -JC (specified improvements, added accountability):}}
...
\textbf{\textcolor{blue}{[Comment: Need source for this health claim - consider interviewing someone from Student Health Services or citing nutrition research. -JC]}}
\end{examplebox}
...
\textbf{\textcolor{blue}{[Comment: Source? This stat feels high without proper polling methodology. -JC]}}
\end{examplebox}
...
\textbf{\textcolor{blue}{[Comment: Can you interview 2-3 specific students affected by this? Names and concrete examples will strengthen this section. -JC]}}
\end{examplebox}
...
\textbf{\textcolor{blue}{[Comment: Consider reaching out to the Commuter Student Association president for an official response. -JC]}}
\end{examplebox}
...
\textbf{\textcolor{blue}{[Comment: This paragraph tries to cover too much ground - consider breaking into separate grafs for each impact area. -JC]}}
\end{examplebox}
...
\textbf{\textcolor{blue}{[Comment: This transition feels abrupt - can you add a sentence bridging student concerns to administrative rationale? -JC]}}
\end{examplebox}
...
\textbf{\textcolor{blue}{[Comment: Try: ``The policy changes have caused problems.'' -JC]}}
\end{examplebox}
...
\textbf{\textcolor{blue}{[Comment: ``Definitely'' and ``immediately'' weaken your argument - let the evidence speak for itself. -JC]}}
\end{examplebox}
\newpage
...
\textbf{\textcolor{blue}{[Comment: This metaphor is powerful - great way to end the piece. Keep it! -JC]}}
\end{examplebox}
...
\textbf{\textcolor{blue}{[Comment: Perfect example - specific, human, and illustrates the broader issue clearly. -JC]}}
\end{examplebox}
...
\textbf{\textcolor{blue}{[Comment: USC enrollment is closer to 35,000 - double-check this figure with official sources. -JC]}}
\end{examplebox}
...
\textbf{\textcolor{blue}{[Comment: University records show August 15, 2024 - verify exact date with dining services. -JC]}}
\end{examplebox}
...
\begin{tikzpicture}[node distance=5cm]
    \node (claim) [draw, rounded corners, minimum width=2.5cm, minimum height=1cm] {Factual Claim};
    \node (source1) [draw, rounded corners, above right of=claim, minimum width=2cm, minimum height=0.8cm] {Source 1};
    \node (source2) [draw, rounded corners, below right of=claim, minimum width=2cm, minimum height=0.8cm] {Source 2};
    \node (verify) [draw, diamond, right of=source1, below of=source1, minimum width=2cm, minimum height=1.5cm] {Sources Agree?};
    \node (accept) [draw, rounded corners, right of=verify, minimum width=2cm, minimum height=0.8cm] {Accept Claim};
    \node (investigate) [draw, rounded corners, below of=verify, minimum width=2cm, minimum height=0.8cm] {Further Investigation};
