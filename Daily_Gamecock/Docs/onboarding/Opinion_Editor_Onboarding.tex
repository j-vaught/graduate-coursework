...
% Table width
\newlength{\tblwidth}
\setlength{\tblwidth}{0.95\textwidth}
...
% Section formatting
\titleformat{\section}[block]{\LARGE\bfseries\color{garnet}}{\thesection.}{0.5em}{}
\titlespacing*{\section}{0pt}{12pt plus 2pt minus 2pt}{4pt plus 1pt minus 1pt}
\titleformat{\subsection}[block]{\Large\bfseries\color{neutral90}}{\thesubsection.}{0.5em}{}
...
\titlespacing*{\subsubsection}{0pt}{6pt plus 2pt minus 2pt}{2pt plus 1pt minus 1pt}
...
\begin{longtable}{p{0.2\tblwidth} p{0.38\tblwidth} p{0.38\tblwidth}}
\toprule
\textbf{Service} & \textbf{Purpose} & \textbf{Notes} \\
\midrule
\textbf{CEO3} & Article writing, previewing, adding titles/authors, managing publication workflow & Get credentials from outgoing editor or EIC \\
\textbf{Slack} & All editorial communication, budgeting, handoffs & Sign up with your USC \texttt{@mailbox.sc.edu} email rather than \texttt{@email.sc.edu} \\
\bottomrule
\end{longtable}
...
Start with \textbf{Opinion\_Editing\_Handbook} (in this same onboarding folder) --- it covers editorial policy and training specific to your role.
...
\begin{longtable}{p{0.38\tblwidth} p{0.30\tblwidth} p{0.28\tblwidth}}
\toprule
...
\begin{longtable}{p{0.38\tblwidth} p{0.58\tblwidth}}
\toprule
...
\begin{longtable}{p{0.30\tblwidth} p{0.35\tblwidth} p{0.30\tblwidth}}
\toprule
\textbf{Channel} & \textbf{Who's In It} & \textbf{Purpose} \\
\midrule
...
\begin{longtable}{p{0.20\tblwidth} p{0.76\tblwidth}}
\toprule
...
\begin{itemize}
    \item \textbf{Yellow} --- on schedule / standard
    \item \textbf{Red} --- pushed, delayed, or cancelled
\end{itemize}
...
\begin{longtable}{p{0.30\tblwidth} p{0.66\tblwidth}}
\toprule
...
\begin{itemize}
    \item \textbf{Save and Check In} --- saves the article and locks it (you're done editing for now)
    \item \textbf{Check Out} --- re-opens the article for further editing
\end{itemize}
...
\begin{longtable}{p{0.08\tblwidth} p{0.20\tblwidth} p{0.64\tblwidth}}
\toprule
...
\begin{enumerate}
    \item \textbf{First pass} --- write inline comments in CEO (bold text, optionally signed with initials) or do full rewrites of problem sections. See \texttt{Opinion\_Editing\_Handbook} for comment formatting.
...
\begin{itemize}
    \item \textbf{Your writers} --- you work with them most directly
    \item \textbf{Copy desk} --- they review everything after you; maintain a good relationship
    \item \textbf{Managing Editor} --- approves pieces after Copy; your direct report in the chain
    \item \textbf{Design lead} --- coordinates visuals and illustrations for your pieces
    \item \textbf{Editor-in-Chief} --- final editorial authority; go to them for fast-track approvals and escalations
\end{itemize}
...
\begin{itemize}
    \item \textbf{Idea on the Budget} --- at least 7--8 days before publication
    \item \textbf{Draft submitted} --- at least 3 days before publication (2 days absolute worst case)
\end{itemize}
...
\begin{longtable}{p{0.15\tblwidth} p{0.13\tblwidth} p{0.25\tblwidth} p{0.43\tblwidth}}
\toprule
\textbf{Day} & \textbf{Time} & \textbf{Meeting} & \textbf{Who} \\
\midrule
Sunday & 1:00 PM & Senior Staff & All section leaders/editors, paid staff \\
Sunday & 2:00 PM & Full Staff & Every member of The Daily Gamecock \\
Sunday & 2:30 PM & Opinion Section & Opinion writers and opinion leadership \\
Wednesday & 5:00 PM & Senior Staff & All section leaders/editors, paid staff \\
\bottomrule
\end{longtable}
...
\begin{longtable}{p{0.22\tblwidth} p{0.36\tblwidth} p{0.38\tblwidth}}
\toprule
...
\begin{longtable}{p{0.22\tblwidth} p{0.28\tblwidth} p{0.46\tblwidth}}
\toprule
...
\begin{itemize}
    \item \textbf{Standard column (online)} --- 700--900 words
    \item \textbf{Print piece} --- 1,500--1,600 words
\end{itemize}
...
\begin{longtable}{p{0.18\tblwidth} p{0.46\tblwidth} p{0.32\tblwidth}}
\toprule
