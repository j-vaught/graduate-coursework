...
\title{Statements --- how to use in \textbf{\textit{Opinion}}\\[4pt] \large Daily Gamecock \textit{\textbf{Opinion}}}
\date{}
...
\newcommand{\deadline}[1]{\textcolor{black}{\textbf{#1}}}

\begin{document}
\maketitle

\begin{tcolorbox}[colback=gray!8,colframe=gray!50,title={Purpose \& Scope}]
...
\subsection*{Good}
\begin{tcolorbox}[colback=green!3,colframe=green!40!black]
