...
\title{EMCH 367 Controls \\ Homework \#1}
...
\textbf{Problem 5 (20pt)} \dotfill & \textbf{\pageref{quest:5}} \\[0.3em]
\textbf{Bonus Problem (20pt)} \dotfill & \textbf{\pageref{quest:6}} \\n\end{tabular}
\vspace{0.2cm}
\end{tcolorbox}
\end{center}
...
\question{Problem 3 (20pt)}\label{quest:3}
\begin{stepbox}[Step 1: Approach]
Work through each requested subpart and show supporting derivations.
\end{stepbox}
...
\question{Problem 4 (20pt)}\label{quest:4}
\begin{stepbox}[Step 1: Approach]
Work through each requested subpart and show supporting derivations.
\end{stepbox}
...
\question{Problem 5 (20pt)}\label{quest:5}
\begin{stepbox}[Step 1: Approach]
Work through each requested subpart and show supporting derivations.
\end{stepbox}
...
\question{Bonus Problem (20pt)}\label{quest:6}
\begin{stepbox}[Step 1: Approach]
Work through each requested subpart and show supporting derivations.
\end{stepbox}
