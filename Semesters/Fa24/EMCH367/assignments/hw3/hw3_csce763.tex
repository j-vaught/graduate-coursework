...
\textbf{Problem 1 (60pt)} \dotfill & \textbf{\pageref{quest:1}} \\[0.3em]
\textbf{Problem 2 (20pt)} \dotfill & \textbf{\pageref{quest:2}} \\[0.3em]
\textbf{Bonus Problem (20pt)} \dotfill & \textbf{\pageref{quest:3}} \\n\end{tabular}
\vspace{0.2cm}
\end{tcolorbox}
\end{center}


\question{Problem 1 (60pt)}\label{quest:1}
...
\question{Bonus Problem (20pt)}\label{quest:3}
\begin{stepbox}[Step 1: Approach]
Work through each requested subpart and show supporting derivations.
\end{stepbox}
