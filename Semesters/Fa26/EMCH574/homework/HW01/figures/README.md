...
This folder owns the figures used by HW01. Editable Typst sources belong in `src/`, and compiled PDFs belong in `generated/`. The shared workshop retains its original copies.
