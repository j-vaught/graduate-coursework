...
\begin{matlabcode}
L=.568; E=200e9; h=.003; b=.037; m=5.35;
u0=.0054; v0=0; t1=10; Nosc=25;
I=b*h^3/12; EI=E*I; k=3*EI/L^3;
wn=sqrt(k/m); fn=wn/(2*pi); tau=2*pi/wn;
t=linspace(0,Nosc*tau,2500);
u=u0*cos(wn*t)+v0/wn*sin(wn*t);
u1=u0*cos(wn*t1)+v0/wn*sin(wn*t1);
plot(t,1000*u,'Color',[0 .427 .459],'LineWidth',1.5);
hold on; plot(t1,1000*u1,'ks'); grid on;
