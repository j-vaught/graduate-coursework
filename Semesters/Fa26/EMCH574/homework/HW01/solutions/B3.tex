...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={B.3. Exact final crossing and the 2\% band. The detail plot resolves the final crossing of the settling band.}]{figures/generated/solutions/B3.pdf}
\caption{B.3. Exact final crossing and the 2\% band. The detail plot resolves the final crossing of the settling band.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={B.3. Detail of the final 2\% crossing.}]{figures/generated/solutions/B3_settling.pdf}
