\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={Free-body diagram for Problem B.2.}]{figures/generated/solutions/horizontal_fbd.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={B.2. Oscillation inside the exponential decay envelope.}]{figures/generated/solutions/B2_envelope.pdf}
