...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={B.4. Original damper, with the required response markers.}]{figures/generated/solutions/B4_healthy.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={B.4. Worn damper, with the required response markers.}]{figures/generated/solutions/B4_worn.pdf}
\caption{B.4. Worn damper, with the required response markers.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={B.4. Displacement responses using identical initial conditions.}]{figures/generated/solutions/B4_compare.pdf}
