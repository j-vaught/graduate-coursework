...
\caption{B.7.4.c. Phase-resonant real displacement over $N_{\mathrm{osc}}=10$ cycles. The dashed orange curve includes the transient required when the force is switched on from rest.}
\end{figure}
