...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={B.7. Steady-state response and a separately identified rest-start interpretation.}]{figures/generated/solutions/B7_time.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={B.7. Dimensionless FRF magnitude and three requested frequency markers.}]{figures/generated/solutions/B7_magnitude.pdf}
\caption{B.7. Dimensionless FRF magnitude and three requested frequency markers.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={B.7. Phase relative to the harmonic force.}]{figures/generated/solutions/B7_phase.pdf}
