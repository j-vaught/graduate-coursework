...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={A.3. Linear response following impact.}]{figures/generated/solutions/A3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={A.3. Small-angle and nonlinear models compared over ten linear periods.}]{figures/generated/solutions/A3_nonlinear.pdf}
