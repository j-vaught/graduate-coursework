...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio,alt={C.9. The requested complex numbers on the unit circle.}]{figures/generated/solutions/C9.pdf}
