...
\textbf{C.1.1(a). Weight.} Take the downward direction as positive and measure the coordinate \(y\) from the undeformed spring position. The mass experiences the gravitational force
...
\textbf{C.1.2(b). Equation of motion.} During vibration, write the absolute downward position as
