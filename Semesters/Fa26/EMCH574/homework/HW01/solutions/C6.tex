...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={C.6. Formal linear response, with the first twice-static maximum marked.}]{figures/generated/solutions/C6.pdf}
