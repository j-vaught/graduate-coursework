...
\textbf{C.3.1. Model and assumptions.} I model the beam as a uniform, massless, linearly elastic cantilever with a lumped tip mass \(m\). I assume small horizontal deflection, one horizontal degree of freedom, no damping, and no applied horizontal force. Since the vertical support reaction balances the weight, the horizontal vibration can be analyzed independently.
...
\textbf{C.3.4. Free-body diagram.} I take the horizontal displacement \(u(t)\) as positive along the transverse \(+y\) direction shown in the assignment; \(x\) runs along the beam. The beam's equivalent spring force therefore acts to the left with magnitude \(ku\), while the vertical support reaction \(N\) balances the downward weight \(mg\).
