...
\textbf{C.3.4. Free-body diagram.} I take the horizontal displacement \(u(t)\) as positive to the right. The beam's equivalent spring force therefore acts to the left with magnitude \(ku\), while the vertical support reaction \(N\) balances the downward weight \(mg\).
