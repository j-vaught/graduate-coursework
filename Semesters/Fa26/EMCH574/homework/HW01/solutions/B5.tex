...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={B.5. Required zero-to-three-second interval.}]{figures/generated/solutions/B5.pdf}
\caption{B.5. Required zero-to-three-second interval.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={B.5. A shorter view resolves the initial behavior.}]{figures/generated/solutions/B5_detail.pdf}
