\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio,alt={Free-body diagram for Problem C.5.}]{figures/generated/solutions/horizontal_fbd.pdf}
