...
cfg=hw01_settings();
L=.568; M=42; mp=.018; vp=935;   % m, kg, kg, m/s
E=200e9; h=.003; b=.037; g=9.81; % Pa, m, m, m/s^2
Nosc=10; t1=10; u0=0;
...
L_A3=.565; M_A3=52; mp_A3=.022; vp_A3=945;
...
disp(table(wnAlternative,tauAlternative, ...
    ...
    'alternative_amplitude_mm','alternative_u10_mm'}));
