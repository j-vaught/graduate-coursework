...
cfg = hw01_settings();
L=.520; E=200e9; h=.004; b=.030; % m, Pa, m, m
m=.70; zeta=.15; Fhat=.012;      % kg, dimensionless, N
N0=3100; Nosc=13; Nf=5000;       % rpm, cycles, requested samples
...
f=linspace(0,12*fn,Nf); p=2*pi*f/wn;
