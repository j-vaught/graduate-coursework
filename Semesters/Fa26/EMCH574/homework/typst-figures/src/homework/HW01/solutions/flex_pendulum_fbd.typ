...
#standalone(
 full-width-artboard(
  cetz-canvas(length: 1mm, {
    ...
    draw.line((28,-2),(44,-2),stroke:(paint:color-secondary,thickness:0.7pt),mark:(end:">"))
    draw.content((34,-6),[$u$])
    draw.content((55,12),[$theta approx (3 u)/(2 L)$])
    draw.rect((111,22),(123,36),..mechanics-body-style)
    draw.content((117,29),[$m$])
    draw.line((111,32),(86,32),..arrow)
    draw.content((97,37),[$k u$])
    draw.line((111,25),(86,25),..arrow)
    draw.content((97,18),[$m g theta$])
    draw.line((126,29),(146,29),stroke:(paint:color-secondary,thickness:0.7pt),mark:(end:">"))
