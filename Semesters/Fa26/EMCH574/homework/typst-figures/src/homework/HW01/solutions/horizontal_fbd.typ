...
#standalone(
 full-width-artboard(
  cetz-canvas(length: 1mm, {
    let arrow = (stroke: (paint: color-tertiary, thickness: 1.1pt, cap: "butt"), mark: (end: ">", scale: 0.7))
    ...
    for x in (33, 114) {
      ...
      draw.content((x, 23), [$m$])
      draw.line((x, 30), (x, 43), ..arrow)
      draw.content((x + 5, 42), [$N$])
      draw.line((x, 16), (x, 3), ..arrow)
      draw.content((x + 6, 4), [$m g$])
    }
    draw.line((27, 23), (8, 23), ..arrow)
    draw.content((15, 28), [$k u$])
    draw.line((108, 27), (82, 27), ..arrow)
    draw.content((92, 32), [$k u$])
    draw.line((108, 19), (82, 19), ..arrow)
    draw.content((92, 13), [$c dot(u)$])
    draw.line((120, 23), (145, 23), ..arrow)
    draw.content((135, 29), [$F(t)$])
    draw.line((44, 36), (59, 36), stroke: (paint: color-secondary, thickness: 0.7pt), mark: (end: ">"))
