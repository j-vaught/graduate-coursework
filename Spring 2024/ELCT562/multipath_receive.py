...
class multipath_receive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "multipath_receive")
        ...
        self.num_samples = num_samples = 512
        self.carrier_freq = carrier_freq = int(915e6)
        ...
        self.qtgui_time_sink_x_0.set_y_axis(-50, 0)

        self.qtgui_time_sink_x_0.set_y_label('Gain [dB]', "")
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('ip:192.168.2.5' if 'ip:192.168.2.5' else iio.get_pluto_uri(), [True, True], num_samples)
        ...
        self.iio_pluto_source_0.set_gain(0, SDR_gain)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(int(self.carrier_freq), self.samp_rate)
    ...
    def set_SDR_gain(self, SDR_gain):
        ...
        self.iio_pluto_source_0.set_gain(0, self.SDR_gain)




def main(top_block_cls=multipath_receive, options=None):
