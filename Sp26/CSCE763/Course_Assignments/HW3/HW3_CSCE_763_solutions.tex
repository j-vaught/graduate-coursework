...
\hline
\cellcolor{USC_Garnet!15} $-1$ & \cellcolor{USC_Garnet!15} $-2$ & \cellcolor{USC_Garnet!15} $-1$ & \cellcolor{USC_Garnet!15} $-2$ \\[0.3em]
\hline
\cellcolor{USC_Garnet!15} $-3$ & \cellcolor{USC_Garnet!15} $-2$ & \cellcolor{USC_Atlantic!15} $1$ & \cellcolor{USC_Garnet!15} $-4$ \\[0.3em]
\hline
\cellcolor{USC_Atlantic!15} $1$ & \cellcolor{USC_Atlantic!15} $8$ & \cellcolor{USC_Atlantic!15} $9$ & \cellcolor{USC_Atlantic!15} $2$ \\[0.3em]
\hline
\cellcolor{USC_Atlantic!15} $3$ & \cellcolor{USC_Atlantic!15} $4$ & \cellcolor{USC_Atlantic!15} $3$ & \cellcolor{USC_Atlantic!15} $4$ \\[0.3em]
\hline
\end{tabular}
\end{center}
