...
\begin{center}
\def\cell#1#2{\cellcolor{#1}\rule{0pt}{1cm}\makebox[1cm]{#2}}
\begin{tabular}{|c|c|c|c|}
\hline
\cell{USC_Garnet!15}{$-1$} & \cell{USC_Garnet!15}{$-2$} & \cell{USC_Garnet!15}{$-1$} & \cell{USC_Garnet!15}{$-2$} \\
\hline
\cell{USC_Garnet!15}{$-3$} & \cell{USC_Garnet!15}{$-2$} & \cell{USC_Atlantic!15}{$1$} & \cell{USC_Garnet!15}{$-4$} \\
\hline
\cell{USC_Atlantic!15}{$1$} & \cell{USC_Atlantic!15}{$8$} & \cell{USC_Atlantic!15}{$9$} & \cell{USC_Atlantic!15}{$2$} \\
\hline
\cell{USC_Atlantic!15}{$3$} & \cell{USC_Atlantic!15}{$4$} & \cell{USC_Atlantic!15}{$3$} & \cell{USC_Atlantic!15}{$4$} \\
\hline
\end{tabular}
\end{center}
