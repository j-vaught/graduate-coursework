...
\vspace{0.3cm}
\begin{center}
\textbf{Figure 2.} Original resolution test chart before smoothing. The three blurred versions use square averaging masks of sizes $n=23$, $n=25$, and $n=45$, respectively. For analysis, consider the 1D scan line through the vertical bars (bottom left): each bar is 5 pixels wide with 20 pixels of separation.
\end{center}
