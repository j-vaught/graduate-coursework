...
\begin{center}
\begin{tikzpicture}[
  imgcell/.style={minimum size=1.3cm, draw=USC_Black70, thick, fill=USC_Black10, font=\large\bfseries},
  gridcell/.style={minimum size=1.1cm, draw=USC_Black70, thick, fill=USC_Black10, font=\large\bfseries},
]

% --- (a) 2x2 image ---
\node[imgcell] at (0, 1.3) {$1$};
\node[imgcell] at (1.3, 1.3) {$2$};
\node[imgcell] at (0, 0) {$3$};
\node[imgcell] at (1.3, 0) {$4$};
