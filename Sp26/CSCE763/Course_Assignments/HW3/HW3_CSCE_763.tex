...
\begin{center}
\begin{tikzpicture}
  % Image (a): White left, black right
  \draw[thick, USC_Atlantic] (0,0) rectangle (4,4);
  \fill[white] (0.05,0.05) rectangle (2.0,3.95);
  \fill[black!85] (2.0,0.05) rectangle (3.95,3.95);
  \node[below] at (2.0,-0.3) {\textbf{(a)}};
  ...
  \begin{scope}[shift={(5.5,0)}]
    ...
    \foreach \i in {0,...,7} {
      \foreach \j in {0,...,7} {
        ...
        \ifnum\checkcolor=0
          \fill[white] ({0.05+\i*0.4875}, {0.05+\j*0.4875}) rectangle ({0.05+\i*0.4875+0.4875}, {0.05+\j*0.4875+0.4875});
        \else
          \fill[black!85] ({0.05+\i*0.4875}, {0.05+\j*0.4875}) rectangle ({0.05+\i*0.4875+0.4875}, {0.05+\j*0.4875+0.4875});
        \fi
      }
    }
    \node[below] at (2.0,-0.3) {\textbf{(b)}};
  \end{scope}
\end{tikzpicture}
\end{center}
...
\fbox{\includegraphics[width=\textwidth]{figures/fig2_original.png}}\\[0.2cm]
\textbf{Original}
\end{minipage}
\hfill
\begin{minipage}{0.21\textwidth}\centering
\fbox{\includegraphics[width=\textwidth]{figures/fig3_a_n23.png}}\\[0.2cm]
\textbf{(a)} $n=23$
\end{minipage}
\hfill
\begin{minipage}{0.21\textwidth}\centering
\fbox{\includegraphics[width=\textwidth]{figures/fig3_b_n25.png}}\\[0.2cm]
\textbf{(b)} $n=25$
\end{minipage}
\hfill
\begin{minipage}{0.21\textwidth}\centering
\fbox{\includegraphics[width=\textwidth]{figures/fig3_c_n45.png}}\\[0.2cm]
\textbf{(c)} $n=45$
\end{minipage}
\end{center}
