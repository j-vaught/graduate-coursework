...
\begin{center}
\fbox{\includegraphics[width=0.35\textwidth]{figures/fig2_original.png}}
\end{center}

\vspace{0.3cm}
\begin{center}
\textbf{Figure 2.} Original resolution test chart ($256 \times 256$). The vertical bars (bottom left) are 5 pixels wide with 20 pixels of separation.
\end{center}

\vspace{0.5cm}

\begin{center}
\fbox{\includegraphics[width=0.3\textwidth]{figures/fig3_a_n23.png}}
\hfill
\fbox{\includegraphics[width=0.3\textwidth]{figures/fig3_b_n25.png}}
\hfill
\fbox{\includegraphics[width=0.3\textwidth]{figures/fig3_c_n45.png}}

\vspace{0.2cm}
\textbf{(a)} $n=23$ \hspace{2.5cm} \textbf{(b)} $n=25$ \hspace{2.5cm} \textbf{(c)} $n=45$
\end{center}

\vspace{0.3cm}
\begin{center}
\textbf{Figure 3.} Three images smoothed by square averaging filters applied to Figure~2. Note the vertical bars merge in~(b) despite the smaller mask size.
\end{center}
