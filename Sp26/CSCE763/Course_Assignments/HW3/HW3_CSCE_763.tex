...
Given the following $3 \times 3$ filter, perform the image filtering using \textbf{convolution} on
%
\[
...
% --- (a) 2x2 image ---
\node[tealcellA] at (0, 1.3) {$1$};
\node[tealcellA] at (1.3, 1.3) {$2$};
\node[tealcellB] at (0, 0) {$3$};
\node[tealcellB] at (1.3, 0) {$4$};
\node[font=\bfseries] at (0.65, -1.1) {(a)};
