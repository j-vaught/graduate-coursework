...
\begin{tikzpicture}[
  ...
  tealcellA/.style={minimum size=1.3cm, draw=USC_Congaree, thick, fill=USC_Congaree!60, font=\large\bfseries, text=white},
  tealcellB/.style={minimum size=1.3cm, draw=USC_Congaree, thick, fill=USC_Congaree!15, font=\large\bfseries},
]
...
\foreach \val/\col/\row in {
  -1/0/2, 0/1/2, -1/2/2,
   ...
   1/0/0, 0/1/0,  1/2/0}
{
  \node[gridcell] at (\col*1.1, \row*1.1) {$\val$};
}
\node[font=\bfseries] at (1.1, -0.9) {(a)};

% --- (b) 2x2 image ---
\node[tealcellA] at (5.0, 1.65) {$1$};
\node[tealcellA] at (6.3, 1.65) {$2$};
\node[tealcellB] at (5.0, 0.35) {$3$};
\node[tealcellB] at (6.3, 0.35) {$4$};
\node[font=\bfseries] at (5.65, -0.9) {(b)};

% --- (c) 3x3 identity image ---
\foreach \val/\col/\row in {
  0/0/2, 0/1/2, 0/2/2,
  0/0/1, 1/1/1, 0/2/1,
  0/0/0, 0/1/0, 0/2/0}
{
  \node[gridcell] at (9.0+\col*1.1, \row*1.1) {$\val$};
}
\node[font=\bfseries] at (10.1, -0.9) {(c)};
