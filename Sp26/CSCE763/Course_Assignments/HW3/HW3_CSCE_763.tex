...
\begin{tabular}{|C|C|C|}
\hline
\rowcolor{lightblue} \textbf{--1} & \textbf{0} & \textbf{--1} \\
\hline
\rowcolor{lightblue} \textbf{0} & \textbf{2} & \textbf{0} \\
\hline
\rowcolor{lightblue} \textbf{1} & \textbf{0} & \textbf{1} \\
\hline
\end{tabular}
...
\begin{tabular}{|C|C|}
\hline
\rowcolor{tealfill} \textbf{1} & \textbf{2} \\
\hline
\rowcolor{teallight} \textbf{3} & \textbf{4} \\
\hline
\end{tabular}
...
\begin{tabular}{|C|C|C|}
\hline
\rowcolor{lightblue} \textbf{0} & \textbf{0} & \textbf{0} \\
\hline
\rowcolor{lightblue} \textbf{0} & \textbf{1} & \textbf{0} \\
\hline
\rowcolor{lightblue} \textbf{0} & \textbf{0} & \textbf{0} \\
\hline
\end{tabular}
