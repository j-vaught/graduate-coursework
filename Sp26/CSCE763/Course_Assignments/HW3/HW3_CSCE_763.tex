...
\begin{center}
\fbox{\includegraphics[width=0.21\textwidth]{figures/fig2_original.png}}
\hfill
\fbox{\includegraphics[width=0.21\textwidth]{figures/fig3_a_n23.png}}
\hfill
\fbox{\includegraphics[width=0.21\textwidth]{figures/fig3_b_n25.png}}
\hfill
\fbox{\includegraphics[width=0.21\textwidth]{figures/fig3_c_n45.png}}

\vspace{0.2cm}
\textbf{Original} \hspace{0.9cm} \textbf{(a)} $n=23$ \hspace{0.9cm} \textbf{(b)} $n=25$ \hspace{0.9cm} \textbf{(c)} $n=45$
\end{center}
