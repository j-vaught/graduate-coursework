...
\begin{tikzpicture}[scale=0.7]
    ...
    % === Shape A: thinner sideways U, deeper notch ===
    \begin{scope}[shift={(0,0)}]
        \draw[thick] (0,3) -- (2.5,3) -- (2.5,3.8) -- (1.1,3.8) -- (1.1,5.2) -- (2.5,5.2) -- (2.5,6) -- (0,6) -- cycle;
        \node[below] at (1.25, 2.5) {$A$};
    \end{scope}

    % === Shape B: 10% taller, 100% wider ===
    \begin{scope}[shift={(5,2)}]
        \draw[thick] (-0.5,4.2) -- (3.5,4.2) -- (1.5,0.9) -- cycle;
        \node[below] at (1.5, 0.5) {$B$};
    \end{scope}

    % === Shape C: 40% taller ===
    \begin{scope}[shift={(9,0.1)}]
                \draw[thick] (2,0) -- (3.5,0) -- (3.5,6) -- (2,6) -- cycle;
        \node[below] at (2.75, -0.3) {$C$};
    \end{scope}
...
\begin{tikzpicture}[scale=0.7]
    ...
    \node[below left] at (0.5,0.5) {$B$};
    \node[below right] at (3.5,0.2) {$C$};
\end{tikzpicture}
\end{center}
