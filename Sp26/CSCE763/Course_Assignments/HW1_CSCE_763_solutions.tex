...
\begin{stepbox}[Step 4: Shortest m-Path]
Check each diagonal in the 8-path:
...
\begin{tikzpicture}[scale=1.1]
    ...
    \fill[USC_Black10] (1.6,-3.4) rectangle (2.4,-2.6);
    \fill[USC_Black10] (2.6,-3.4) rectangle (3.4,-2.6);
    % Blocking shared neighbors highlighted in red
    \fill[USC_Rose!25] (-0.4,-2.4) rectangle (0.4,-1.6); % (0,2)=1 blocks (0,3)->(1,2)
    \fill[USC_Rose!25] (2.6,-2.4) rectangle (3.4,-1.6); % (3,2)=1 blocks (2,2)->(3,1)
    % Corrected m-path highlight
    \fill[USC_Honeycomb!30] (-0.4,-3.4) rectangle (0.4,-2.6);
    \fill[USC_Honeycomb!30] (0.6,-2.4) rectangle (1.4,-1.6);
    \fill[USC_Honeycomb!30] (1.6,-2.4) rectangle (2.4,-1.6);
    \fill[USC_Honeycomb!30] (2.6,-1.4) rectangle (3.4,-0.6);
    ...
    \node[above right, USC_Atlantic, font=\bfseries\small] at (3.1,0.4) {$q$};
    % Labels
    \node[right, font=\small] at (3.8,-1.5) {Red cells block diagonals:};
    \node[right, font=\small, USC_Rose] at (3.8,-2.0) {$(0,2){=}1 \in V$ blocks};
    \node[right, font=\small, USC_Rose] at (3.8,-2.5) {$(3,2){=}1 \in V$ blocks};
    \node[right, font=\small] at (3.8,-3.0) {$\Rightarrow$ must use 4-adj steps};
\end{tikzpicture}
\end{center}

Both diagonals from the 8-path fail m-adjacency. The shortest m-path reverts to the 4-path:

$(0,3) \to (0,2) \to (1,2) \to (2,2) \to (3,2) \to (3,1) \to (3,0)$. Length = \textbf{6}.
\end{stepbox}
