...
\begin{tabular}{|c|>{\raggedright\arraybackslash}p{0.16\textwidth}|>{\raggedright\arraybackslash}p{0.24\textwidth}|>{\raggedright\arraybackslash}p{0.20\textwidth}|>{\raggedright\arraybackslash}p{0.18\textwidth}|}
\hline
\textbf{Iter.} & \textbf{Current Interval} & \textbf{Normalized Position $z$} & \textbf{Chosen Symbol} & \textbf{Updated Interval} \\
\hline
...
\hline
4 & $[0.22,0.2225)$ & $z = (0.222355 - 0.22)/0.0025 = 0.942$ & $!$, since $z \in [0.9,1)$ & \shortstack[l]{$[0.22225,$\\$0.2225)$} \\
\hline
\end{tabular}
}
\normalsize
...
\qquad
\mathbf{M}_H =
\begin{bmatrix} -1 & -1 & -1 \\ 2 & -4 & 2 \\ -1 & -1 & -1 \end{bmatrix}
\]
...
\qquad
\mathbf{M}_V =
\begin{bmatrix} -1 & 2 & -1 \\ -1 & -4 & -1 \\ -1 & 2 & -1 \end{bmatrix}
\]
...
\qquad
\mathbf{M}_{45} =
\begin{bmatrix} -1 & -1 & 2 \\ -1 & -4 & -1 \\ 2 & -1 & -1 \end{bmatrix}
\]
...
\qquad
\mathbf{M}_{-45} =
\begin{bmatrix} 2 & -1 & -1 \\ -1 & -4 & -1 \\ -1 & -1 & 2 \end{bmatrix}
\]
...
\begin{tabular}{|l|c|}
\hline
\textbf{Neighborhood Type} & \textbf{Response of the Matching Mask} \\
\hline
Exact 1-pixel break & $2 + 2 = \mathbf{4}$ \\
Normal unbroken line point & $2 + (-4) + 2 = \mathbf{0}$ \\
Background patch & $\mathbf{0}$ \\
...
\[
\boxed{
\mathbf{M}_H = \begin{bmatrix} -1 & -1 & -1 \\ 2 & -4 & 2 \\ -1 & -1 & -1 \end{bmatrix}, \quad
\mathbf{M}_V = \begin{bmatrix} -1 & 2 & -1 \\ -1 & -4 & -1 \\ -1 & 2 & -1 \end{bmatrix}
}
\]
\[
\boxed{
\mathbf{M}_{45} = \begin{bmatrix} -1 & -1 & 2 \\ -1 & -4 & -1 \\ 2 & -1 & -1 \end{bmatrix}, \quad
\mathbf{M}_{-45} = \begin{bmatrix} 2 & -1 & -1 \\ -1 & -4 & -1 \\ -1 & -1 & 2 \end{bmatrix}
}
\]
