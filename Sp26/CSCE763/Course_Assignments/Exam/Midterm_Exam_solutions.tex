...
\textbf{Step 1: Identify pixels in $V = \{1\}$}
...
\textbf{Step 2: Trace the shortest m-path}

Two pixels with values in $V$ are \textbf{m-adjacent} if: (1) they are 4-adjacent, OR (2) they are diagonally adjacent AND their shared 4-neighbors contain no pixels in $V$.
...
\textbf{Path sequence:} $(0,0) \to (1,1) \to (2,2) \to (2,3) \to (3,3) \to (4,3) \to (4,4)$

\vspace{0.3cm}

\textbf{Justification for diagonal moves:}
