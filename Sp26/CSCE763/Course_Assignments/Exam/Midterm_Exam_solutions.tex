...
\includegraphics[width=0.28\textwidth]{fireworks_vibrance.png} &
\includegraphics[width=0.28\textwidth]{fireworks_warm.png} \\
\small Saturation Boost & \small Vibrance & \small Warm Temperature
\end{tabular}
\end{center}

\textbf{Saturation}: Uniformly boosts all color intensity---can cause clipping in already-vivid areas.

\textbf{Vibrance}: ``Smart'' saturation that boosts muted colors more than saturated ones, preventing oversaturation.
