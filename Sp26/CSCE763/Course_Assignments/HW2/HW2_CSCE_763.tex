...
\begin{tikzpicture}[scale=1.0]
    ...
    \begin{scope}[shift={(0,0)}]
        ...
        \draw[thick, USC_Atlantic] (0,3) -- (3.8,0);
    ...
    \begin{scope}[shift={(8,0)}]
        ...
        \draw[thick, USC_Atlantic] (0,0) -- (3.8,3);

        % Dashed lines showing the box extent
        \draw[dashed, thick, USC_Atlantic] (3.8,3) -- (3.8,0);
        \draw[dashed, thick, USC_Atlantic] (0,3) -- (3.8,3);
