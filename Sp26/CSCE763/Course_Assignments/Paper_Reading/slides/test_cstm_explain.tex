...
\node[imgframe] (uw_cstm) at (1.5, 3.0)
...
\node[imgframe] (wd_cstm) at (7.5, 3.0)
...
\node[imgframe] (tl_cstm) at (13.5, 3.0)
    {\includegraphics[width=0.6cm]{cstm_demo/tele_120mm_cstm.jpg}};
\node[sublbl, anchor=north west] at (tl_cstm.south west)
    {Shrunk $0.2\times$};

% Arrows: originals → results (straight down)
\draw[arr=atlantic] (uw_orig.south) -- (uw_cstm.north);
\draw[arr=horseshoe] (wd_orig.south) -- (wd_cstm.north);
\draw[arr=rose] (tl_orig.south) -- (tl_cstm.north);
