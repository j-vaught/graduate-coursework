...
tex.sprint(string.format(
    ...
    x1, h + 0.15))
tex.sprint(string.format(
    "\\node[font=\\sffamily\\footnotesize,text=bk70,anchor=north] at (%.2f,%.2f) {Aperture};",
    x_ap, -casing_y - 0.15))
tex.sprint(string.format(
    "\\node[font=\\sffamily\\footnotesize,text=atlantic,anchor=south] at (%.2f,%.2f) {Biconcave};",
    x2, h + 0.15))
tex.sprint(string.format(
    "\\node[font=\\sffamily\\footnotesize,text=atlantic,anchor=north] at (%.2f,%.2f) {Biconvex};",
    x3, -casing_y - 0.15))
tex.sprint(string.format(
