...
-- Lens casing — two horizontal lines running just outside the lens tops/bottoms
-- from a bit past the front lens (lens1) to the CMOS
local casing_y = h + 0.1          -- just outside lens aperture
