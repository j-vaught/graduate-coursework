...
-- Casing
local casing_y = h          -- ray collision boundary
local casing_outer = h + 0.15  -- drawn casing line position
...
-- Aperture (connects to casing)
tex.sprint(string.format(
    "\\draw[bk70, thick] (%.2f,%.2f)--(%.2f,%.2f);",
    x_ap, casing_outer, x_ap, ap_gap))
tex.sprint(string.format(
    "\\draw[bk70, thick] (%.2f,%.2f)--(%.2f,%.2f);",
    x_ap, -ap_gap, x_ap, -casing_outer))

-- Lens casing — two horizontal lines running outside the lenses
local casing_left = x1 - 0.6     -- extends past front of lens1
local casing_right = sensor_x + 0.12
tex.sprint(string.format(
    "\\draw[bk70, thick] (%.2f,%.2f)--(%.2f,%.2f);",
    casing_left, casing_outer, casing_right, casing_outer))
tex.sprint(string.format(
    "\\draw[bk70, thick] (%.2f,%.2f)--(%.2f,%.2f);",
    casing_left, -casing_outer, casing_right, -casing_outer))

-- Mounting brackets: vertical lines from lens edges to casing
local bracket_lenses = {x1, x2, x3}
for _, lx in ipairs(bracket_lenses) do
    tex.sprint(string.format(
        "\\draw[bk70, thin] (%.2f,%.2f)--(%.2f,%.2f);",
        lx, h, lx, casing_outer))
    tex.sprint(string.format(
        "\\draw[bk70, thin] (%.2f,%.2f)--(%.2f,%.2f);",
        lx, -h, lx, -casing_outer))
end
...
tex.sprint(string.format(
    "\\draw[bk70, thick] (%.2f,%.2f)--(%.2f,%.2f);",
    casing_left, -casing_outer, casing_left, casing_outer))
tex.sprint(string.format(
    "\\draw[bk70, thick] (%.2f,%.2f)--(%.2f,%.2f);",
    casing_right, -casing_outer, casing_right, casing_outer))
...
tex.sprint(string.format(
    ...
    sensor_x + 0.06, casing_outer + 0.15))
