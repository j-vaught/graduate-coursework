...
local lens1 = {Rl = \PARAM,  Rr = 999}   -- PARAM sweeps Rl of plano-convex
...
-- Readout
tex.sprint(string.format(
    "\\node[font=\\sffamily\\scriptsize,text=warmgrey,anchor=south west] at (%.2f,%.2f) {$R_{L1}=%.1f$};",
    xmin + 0.2, -casing_y - 0.4, lens1.Rl))
