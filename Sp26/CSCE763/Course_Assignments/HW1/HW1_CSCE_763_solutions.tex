...
\begin{tikzpicture}[scale=1.1]
    ...
    \fill[USC_Black10] (1.6,-3.4) rectangle (2.4,-2.6);
    % Path highlight
    \fill[USC_Honeycomb!30] (-0.4,-3.4) rectangle (0.4,-2.6);
    \fill[USC_Honeycomb!30] (-0.4,-2.4) rectangle (0.4,-1.6);
    \fill[USC_Honeycomb!30] (0.6,-1.4) rectangle (1.4,-0.6);
    \fill[USC_Honeycomb!30] (1.6,-1.4) rectangle (2.4,-0.6);
    \fill[USC_Honeycomb!30] (2.6,-0.4) rectangle (3.4,0.4);
    % Grid
    \draw[thin, gray] (-0.4,-0.4) rectangle (0.4,0.4); \node at (0,0) {3};
    \draw[thin, gray] (0.6,-0.4) rectangle (1.4,0.4); \node at (1,0) {1};
    \draw[thin, gray] (1.6,-0.4) rectangle (2.4,0.4); \node at (2,0) {2};
    ...
    \draw[thin, gray] (2.6,-3.4) rectangle (3.4,-2.6); \node at (3,-3) {2};
    % Path arrows
    \draw[-{Stealth}, very thick, USC_Honeycomb] (0,-3) -- (0,-2);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (0,-2) -- (1,-1);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (1,-1) -- (2,-1);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (2,-1) -- (3,0);
    % p and q
    \draw[very thick, USC_Garnet] (-0.4,-3.4) rectangle (0.4,-2.6);
    \draw[very thick, USC_Atlantic] (2.6,-0.4) rectangle (3.4,0.4);
    \node[below left, USC_Garnet, font=\bfseries\small] at (-0.1,-3.4) {$p$};
...
\begin{tikzpicture}[scale=1.1]
    ...
    \fill[USC_Honeycomb!30] (-0.4,-3.4) rectangle (0.4,-2.6);
    \fill[USC_Honeycomb!30] (-0.4,-2.4) rectangle (0.4,-1.6);
    \fill[USC_Honeycomb!30] (0.6,-2.4) rectangle (1.4,-1.6);
    \fill[USC_Honeycomb!30] (1.6,-2.4) rectangle (2.4,-1.6);
    \fill[USC_Honeycomb!30] (2.6,-2.4) rectangle (3.4,-1.6);
    \fill[USC_Honeycomb!30] (2.6,-1.4) rectangle (3.4,-0.6);
    \fill[USC_Honeycomb!30] (2.6,-0.4) rectangle (3.4,0.4);
    % Grid
    \draw[thin, gray] (-0.4,-0.4) rectangle (0.4,0.4); \node at (0,0) {3};
    \draw[thin, gray] (0.6,-0.4) rectangle (1.4,0.4); \node at (1,0) {1};
    ...
    % Path arrows
    \draw[-{Stealth}, very thick, USC_Honeycomb] (0,-3) -- (0,-2);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (0,-2) -- (1,-2);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (1,-2) -- (2,-2);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (2,-2) -- (3,-2);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (3,-2) -- (3,-1);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (3,-1) -- (3,0);
    % p and q
    \draw[very thick, USC_Garnet] (-0.4,-3.4) rectangle (0.4,-2.6);
    \draw[very thick, USC_Atlantic] (2.6,-0.4) rectangle (3.4,0.4);
    \node[below left, USC_Garnet, font=\bfseries\small] at (-0.1,-3.4) {$p$};
...
\begin{tikzpicture}[scale=1.1]
    ...
    \draw[thin, gray] (2.6,-3.4) rectangle (3.4,-2.6); \node at (3,-3) {2};
    % Path arrows
    \draw[-{Stealth}, very thick, USC_Honeycomb] (0,-3) -- (1,-2);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (1,-2) -- (2,-2);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (2,-2) -- (3,-1);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (3,-1) -- (3,0);
    % p and q
    \draw[very thick, USC_Garnet] (-0.4,-3.4) rectangle (0.4,-2.6);
    \draw[very thick, USC_Atlantic] (2.6,-0.4) rectangle (3.4,0.4);
...
\begin{tikzpicture}[scale=1.1]
    ...
    \fill[USC_Honeycomb!30] (-0.4,-3.4) rectangle (0.4,-2.6);
    \fill[USC_Honeycomb!30] (-0.4,-2.4) rectangle (0.4,-1.6);
    \fill[USC_Honeycomb!30] (-0.4,-1.4) rectangle (0.4,-0.6);
    \fill[USC_Honeycomb!30] (0.6,-0.4) rectangle (1.4,0.4);
    \fill[USC_Honeycomb!30] (1.6,-0.4) rectangle (2.4,0.4);
    \fill[USC_Honeycomb!30] (2.6,-0.4) rectangle (3.4,0.4);
    ...
    % m-path arrows
    \draw[-{Stealth}, very thick, USC_Honeycomb] (0,-3) -- (0,-2);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (0,-2) -- (0,-1);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (0,-1) -- (1,0);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (1,0) -- (2,0);
    \draw[-{Stealth}, very thick, USC_Honeycomb] (2,0) -- (3,0);
    % p and q
    \draw[very thick, USC_Garnet] (-0.4,-3.4) rectangle (0.4,-2.6);
    \draw[very thick, USC_Atlantic] (2.6,-0.4) rectangle (3.4,0.4);
    \node[below left, USC_Garnet, font=\bfseries\small] at (-0.1,-3.4) {$p$};
