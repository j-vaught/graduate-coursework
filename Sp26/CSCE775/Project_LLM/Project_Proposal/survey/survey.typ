...
#v(1fr)
#align(center)[
  #text(size: 10pt, tracking: 2pt, weight: "regular")[CSCE 775: DEEP REINFORCEMENT LEARNING]
  #v(24pt)
  #line(length: 60%, stroke: 0.5pt + luma(180))
  #v(24pt)
  #text(size: 22pt, weight: "bold")[A  Survey of\ Reinforcement Learning Methods\ for Large Language Model Alignment]
  #v(24pt)
  #line(length: 60%, stroke: 0.5pt + luma(180))
  #v(32pt)
...
The KL penalty, controlled by $beta$, is critical, since without it, the model would exploit weaknesses in the reward model to achieve high scores through degenerate outputs, a failure mode known as reward hacking.
// TODO: restore @sec:security reference when Security section is uncommented
