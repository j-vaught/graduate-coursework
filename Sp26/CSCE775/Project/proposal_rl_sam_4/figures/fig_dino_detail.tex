...
\node[block, fill=Congaree!12, right=3.0cm of features] (matching) {Cosine\\Matching};
\node[data, fill=Horseshoe!15, right=3.0cm of matching] (prompts) {Initial\\Prompts};

% Arrows stay at block level only
\draw[arr] (features.east) -- (matching.west);
...
\node[below=2.0cm of input, anchor=north] (img_input) {
    \includegraphics[width=3.8cm]{dino_stage/ref_original_clean.png}
};
...
\node[below=2.0cm of resize, anchor=north] (img_resize) {
    \includegraphics[width=3.8cm]{dino_stage/ref_resized_clean.png}
};
...
\node[below=2.0cm of dino, anchor=north] (img_dino) {
    \includegraphics[width=3.8cm]{dino_stage/ref_pca_features_clean.png}
};
...
\node[below=2.0cm of features, anchor=north] (img_features) {
    \includegraphics[width=3.8cm]{dino_stage/ref_pca_features_overlay_clean.png}
};
...
\node[below=2.0cm of prompts, anchor=north] (img_prompts) {
    \includegraphics[width=3.8cm]{dino_stage/prompts_clean.png}
};
