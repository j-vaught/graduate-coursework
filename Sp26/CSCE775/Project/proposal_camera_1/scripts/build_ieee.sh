...
latexmk -g -pdf -interaction=nonstopmode -halt-on-error proposal_ieee.tex
cp proposal_ieee.pdf "$OUT_DIR/proposal2_ieee_final.pdf"
latexmk -c
popd >/dev/null

echo "Built $OUT_DIR/proposal2_ieee_final.pdf"
