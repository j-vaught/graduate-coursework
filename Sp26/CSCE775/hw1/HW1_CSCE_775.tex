...
% Row labels (y=2 top, y=0 bottom)
% Column labels (x=0 left, x=2 right)

% Row 2 (top)
\node[cell, fill=white] at (0, 2) {$(0,2)$};
\node[cell, fill=white] at (1.6, 2) {$(1,2)$};
\node[cell, fill=USC_Horseshoe!40, font=\small\bfseries] at (3.2, 2) {\shortstack{Goal\\$r=+10$}};

% Row 1 (middle)
\node[cell, fill=white] at (0, 0.8) {$(0,1)$};
\node[cell, fill=USC_Black90, text=white, font=\small\bfseries] at (1.6, 0.8) {Wall};
\node[cell, fill=USC_Rose!40, font=\small\bfseries] at (3.2, 0.8) {\shortstack{Trap\\$r=-5$}};

% Row 0 (bottom)
\node[cell, fill=USC_Atlantic!15, font=\small\bfseries] at (0, -0.4) {Start};
\node[cell, fill=white] at (1.6, -0.4) {$(1,0)$};
\node[cell, fill=white] at (3.2, -0.4) {$(2,0)$};
...
\node[cell] at (0, 2) {};
\node[cell] at (1.6, 2) {};
\node[cell, fill=USC_Black10] at (3.2, 2) {G};
\node[cell] at (0, 0.8) {};
\node[cell, fill=USC_Black90, text=white] at (1.6, 0.8) {W};
\node[cell, fill=USC_Black10] at (3.2, 0.8) {T};
\node[cell] at (0, -0.4) {};
\node[cell] at (1.6, -0.4) {};
\node[cell] at (3.2, -0.4) {};
\end{tikzpicture}
...
\node[cell] at (0, 2) {};
\node[cell] at (1.6, 2) {};
\node[cell, fill=USC_Horseshoe!30] at (3.2, 2) {G};
\node[cell] at (0, 0.8) {};
\node[cell, fill=USC_Black90, text=white] at (1.6, 0.8) {W};
\node[cell, fill=USC_Rose!30] at (3.2, 0.8) {T};
\node[cell] at (0, -0.4) {};
\node[cell] at (1.6, -0.4) {};
\node[cell] at (3.2, -0.4) {};
\end{tikzpicture}
