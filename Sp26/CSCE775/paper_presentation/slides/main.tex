...
\begin{frame}{What this paper is}
  ...
  \begin{itemize}\setlength\itemsep{0.5em}
    \item \textbf{Evolutionary Discovery of RL Algorithms via LLMs} \hfill
          {\small\color{UofSCGray70}Sygkounas, Loutfi \& Persson --- GECCO 2026}
...
\begin{frame}{The canonical RL algorithms}
  ...
  \vspace{1.2em}
  Every modern control-RL system runs on one of these.\\[0.3em]
  {\color{UofSCGray70}\small Nothing genuinely new has been added in $\sim$7 years.}
\end{frame}
