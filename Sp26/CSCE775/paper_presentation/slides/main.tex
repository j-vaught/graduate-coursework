...
\begin{frame}{What AutoML has automated}
  ...
  \begin{itemize}\setlength\itemsep{0.45em}
    \item \textbf{Architecture} --- NAS, AmoebaNet
    \item \textbf{Hyperparameters} --- PB2, OptFormer
    \item \textbf{Reward function} --- Eureka, REvolve
    \item \textbf{Preference loss} --- DiscoPOP
    \item \hilite{The update rule itself} --- open, until this paper
  \end{itemize}
\end{frame}
