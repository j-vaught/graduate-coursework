...
\begin{frame}{The Question}
  \vfill
  \centering
  {\Huge\color{UofSCGarnet}\textbf{Can an LLM + evolution}}\\[0.6em]
  {\Huge\color{UofSCGarnet}\textbf{invent an RL algorithm}}\\[0.6em]
  {\Huge\color{UofSCGarnet}\textbf{from scratch?}}\\[1.8em]
  {\large\color{UofSCGray70}\textit{No value functions. No policy gradients. No Bellman updates.}}
  \vfill
\end{frame}
