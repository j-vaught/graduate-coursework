...
#let branches = (
  ec:    (y: y_ec,    color: garnet,    label: [Evolutionary \ Computation],
          start: (1957, 0),  end: (2021, 0),  end_style: "terminate"),
  neuro: (y: y_neuro, color: rose,      label: [Neuroevolution],
          start: (2002, 0),  end: (2018, 6),  end_style: "terminate"),
  ...
  meta:  (y: y_meta,  color: horseshoe, label: [Meta-Learning \ & AutoRL],
          start: (2016, 6),  end: (2026, 0),  end_style: "fade"),
  code:  (y: y_code,  color: honeycomb, label: [LLM & \ Code Gen.],
          start: (2017, 6),  end: (2022, 6),  end_style: "fade"),
...
#let items = (
  ...
  (branch: "ec", year: 2019, month: 1,  dir: "below", bold: "Ecoffet et al.", small: "Go-Explore '19-01"),
  (branch: "ec", year: 2019, month: 2,  dir: "above", bold: "Real et al.",    small: "AmoebaNet '19-02"),
  ...
  (branch: "deep", year: 2018, month: 2,  dir: "below", bold: "TD3",             small: "Fujimoto '18-02"),
