"""
Train and solve script for the Circuit Minimization domain.

Usage:
    python train_circuit.py train [--step_max 20] [--max_itrs 50000] [--dir training/circuit]
    python train_circuit.py solve --file circuit_test_easy.pkl [--dir training/circuit]
    python train_circuit.py generate [--num 100] [--step_min 5] [--step_max 30] [--file circuit_test.pkl]
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Circuit Minimization training/solving")
    sub = parser.add_subparsers(dest="cmd")

    p_train = sub.add_parser("train")
    p_train.add_argument("--domain", default="circuit.3.8")
    p_train.add_argument("--heur", default="resnet_fc.500H_4B")
    p_train.add_argument("--pathfind", default="graph_v")
    p_train.add_argument("--dir", default="training/circuit")
    ...
    p_train.add_argument("--t_file", default="circuit_test_easy.pkl")
    ...
    p_gen.add_argument("--file", default="circuit_test.pkl")
