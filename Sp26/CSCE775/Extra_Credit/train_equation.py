"""
Train and solve script for the Equation Simplification domain.

Usage:
    python train_equation.py train [--step_max 20] [--max_itrs 50000] [--dir training/equation]
    python train_equation.py solve --file equation_test_easy.pkl [--dir training/equation]
    python train_equation.py generate [--num 100] [--step_min 5] [--step_max 30] [--file equation_test.pkl]
"""
...
def cmd_solve(args: argparse.Namespace) -> None:
    sys.argv = [
        ...
        "--dir", args.dir,
        "--file", args.file,
        "--search_itrs", str(args.search_itrs),
    ]
    from deepxube._solve import solve_cli
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Equation Simplification training/solving")
    sub = parser.add_subparsers(dest="cmd")

    # Train
    p_train = sub.add_parser("train")
    p_train.add_argument("--domain", default="equation.4.8")
    p_train.add_argument("--heur", default="resnet_fc.500H_4B")
    p_train.add_argument("--pathfind", default="graph_v")
    p_train.add_argument("--dir", default="training/equation")
    ...
    p_train.add_argument("--t_file", default="equation_test_easy.pkl")
    ...
    p_gen.add_argument("--file", default="equation_test.pkl")
