...
``Small Object Detection: A Comprehensive Survey on Challenges, Techniques and Real-World Applications,'' \textit{Intelligent Systems with Applications}, 2025. doi: \url{10.1016/j.iswa.2025.200561}

\bibitem{smallobj_survey2}
``Small object detection in diverse application landscapes,'' \textit{Multimedia Tools and Applications}, vol. 83, pp. 40321--40359, 2024. doi: \url{10.1007/s11042-024-18866-w}

\bibitem{smallobj_survey3}
``Deep learning-based detection from the perspective of small or tiny objects: A comparative review,'' \textit{Image and Vision Computing}, vol. 117, p. 104813, 2022. doi: \url{10.1016/j.imavis.2022.104439}
...
\bibitem{yolo_review}
``A Comprehensive Review of YOLO: From YOLOv1 to YOLOv8 and Beyond,'' \textit{arXiv preprint arXiv:2304.00501}, 2023. doi: \url{10.48550/arXiv.2304.00501}
