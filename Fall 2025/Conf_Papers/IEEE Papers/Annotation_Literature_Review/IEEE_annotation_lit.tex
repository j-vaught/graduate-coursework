...
\title{Object Tracking \& Classification in Marine Radar: A Survey of Data Annotation Strategies}

\author{\IEEEauthorblockN{J.C. Vaught, Yi Wang, and Douglas Cahl}
...
% --- Abstract (Optional, created from Intro if needed, otherwise standard sections) ---
% Note: IEEE conference papers usually require an abstract. 
% If you wish to add one, uncomment the block below.
%\begin{abstract}
% Marine radar plan position indicator (PPI) images present distinctive challenges for annotation...
%\end{abstract}
...
\begin{table}[!t]
\centering
\caption{Cost–Utility Sketch for Common Annotation Paradigms in Radar PPI Contexts}
\label{tab:ann_summary}
\begin{tabular}{p{0.2\linewidth} p{0.3\linewidth} p{0.35\linewidth}}
\toprule
\textbf{Type} & \textbf{Typical Cost} & \textbf{Example Use on Radar} \\
\midrule
Bounding boxes & Moderate cost; widely adopted & PPI ship detection and radar–vision fusion \cite{ref4,ref2,ref1} \\
\midrule
Pixel-wise masks & Highest cost; $\approx$1 min per instance \cite{coco_time_2024} & Pixel-level ship segmentation on PPI \cite{ref10} \\
\midrule
Center-point labels & Lowest cost; $\approx$7s per object \cite{extreme_clicking_iccv2017} & Center-based radar–camera fusion \cite{ref13} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[!t]
    ...
    \IfFileExists{fig_axis_vs_rotated.png}{%
        ...
        \fbox{\rule{0pt}{1.5in}\rule{\linewidth}{0pt}}% placeholder box
    }
...
\bibitem{ref2}
W. Huang \textit{et al.}, ``Surface vessels detection and tracking method and datasets with multi-source data fusion in real-world complex scenarios,'' \textit{Sensors}, vol. 25, no. 7, 2179, 2025. \href{https://doi.org/10.3390/s25072179}{doi: 10.3390/s25072179}.
...
\bibitem{ref5}
X. Yang \textit{et al.}, ``Ship instance segmentation based on rotated bounding boxes for SAR images,'' \textit{Remote Sensing}, vol. 15, no. 5, 1324, 2023. \href{https://doi.org/10.3390/rs15051324}{doi: 10.3390/rs15051324}.
...
\bibitem{ref14}
J. Choi \textit{et al.}, ``PoLaRIS dataset: A maritime object detection and tracking dataset in Pohang canal,'' 2024. \href{https://arxiv.org/abs/2412.06192}{arXiv:2412.06192}.
...
C. Agnew \textit{et al.}, ``Pretraining instance segmentation models with bounding box annotations,'' \textit{Patterns}, vol. 5, no. 12, 100984, 2024. \href{https://doi.org/10.1016/j.iswa.2024.200454 }{doi: 10.1016/j.iswa.2024.200454}.
