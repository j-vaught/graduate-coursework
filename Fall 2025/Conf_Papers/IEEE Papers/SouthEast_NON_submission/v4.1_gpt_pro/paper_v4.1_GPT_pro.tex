...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/fig08_temporal_aggregates_pgfplots.pdf}
...
To study the impact of temporal context, echo-trail variants of the YOLO-style detector are trained with different trail lengths.
