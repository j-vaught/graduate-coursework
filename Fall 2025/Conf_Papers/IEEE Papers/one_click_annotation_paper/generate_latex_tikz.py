...
and drawing bounding boxes using TikZ based on the actual data.
"""
...
def generate_latex_with_tikz_bboxes(processed_data_dir, output_latex_path):
    """Generate LaTeX document with 6-panel figure using TikZ to draw bounding boxes"""
    ...
    latex_content = r"""% Radar3000 Dataset Sample Images with TikZ Annotations
...
"""
    ...
    for idx, frame_id in enumerate(selected_frame_ids):
        ...
        latex_content += f"\\caption{{Frame ID: {frame_id}}}\n"
...
"""
    ...
    print(f"LaTeX document with TikZ annotations generated: {output_latex_path}")
...
if __name__ == "__main__":
    ...
    output_latex_path = "/Users/jacobvaught/Downloads/Classes/Fall 2025/Conf_Papers/IEEE Papers/one_click_annotation_paper/radar3000_samples_tikz.tex"
    
    # Generate the LaTeX document with TikZ annotations
    generate_latex_with_tikz_bboxes(processed_data_dir, output_latex_path)
    
    print("LaTeX document with TikZ bounding boxes has been generated successfully!")