...
\section{Results}
\label{sec:results}
This section summarizes model-training results from our current experiments and provides a ranked comparison across detector and segmentation architectures. We report both mAP@0.5 and mAP@0.5:0.95.
