...
\caption{Sample detections from the RADAR3000 public dataset. These $3000$ radar frames with boat annotations serve as our pretraining source domain. Lime bounding boxes show detected boats across diverse marine environments.}
...
\caption{Sample labeled frames from the USC Canal dataset showing dynamic (green) and static (orange) boat detections. Higher clutter and environmental complexity compared to RADAR3000 reflect the challenges of inland and near-coastal autonomy.}
