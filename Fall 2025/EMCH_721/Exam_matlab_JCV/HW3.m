...
CPratio = -15e-2;              % static offset as % of chord
QPratio = 25e-2;               % aerodynamic offset ratio as % of chord
L       = 2.5;                   % span, m
scale   = 8;                   % scale up factor for plunge displ
NW      = 4;                   % number of flexural modes
NPhi    = 3;                   % number of torsional modes 
Ustart  = 0; 
Uend    = 14;                  % flutter range
UFrigid = 13.034;               % flutter speed of rigid airfoil model from HW01
UFread  = 13.23;                % flutter speed of structural dynamics wing model read on the plot
...
ifA2torsion  = 0; % plot Phi modeshapes
...
ifdisplayfV  = 0; % display freq. and modeshapes

ifanimation  = 0; % animate GVT and flutter modeshapes
