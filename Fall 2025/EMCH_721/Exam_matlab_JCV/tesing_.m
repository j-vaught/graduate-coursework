...
sectionChoice = "B4";  % "A","B","B3","B4","B5","C","D","E","F"
...
wt = 2*pi*ft; 
wh = 2*pi*fh;
zh = 4e-2; % plunge damping ratio
zt = 3.5e-2; % pitch damping ratio
CPratio = -15e-2; 
...
% ---- ----
UFdamped = 13.04408; % enter UFadjusted from section B.5
...
zhCLratio = 4.2; 
ztCLratio = 2.4; % Section F: zh desired CL damping increase
...
Kdh = 2.7;  % YOU will need to adjust this. adjusted FB coefficients Section E3
Kdt = -4.3; % YOU will need to adjust this. adjusted FB coefficients Section E3
