...
sectionChoice = "E";  % "A","B","B3","B4","B5","C","D","E","F"
...
zhCLratio = 3.3; 
ztCLratio = 1.6; % Section F: zh desired CL damping increase
...
Kdt_max =  50;
step = 0.1;
Kdh = 100; %default value to use if search fails
Kdt = -200; %default value to use if search fails
